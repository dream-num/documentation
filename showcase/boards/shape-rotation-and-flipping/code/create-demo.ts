...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'board-shape-transforms'
  ...
  try {
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Board transform demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
