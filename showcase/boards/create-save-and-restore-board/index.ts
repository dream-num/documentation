...
const metadata: ShowcaseMetadata = {
  ...
  title: { 'en-US': 'Create, Save, and Restore a Board', 'zh-CN': '创建、保存与恢复 Boards' },
  description: {
    'en-US':
  ...
  guide: {
    overview: {
      ...
      'zh-CN':
        'Tern 野外站包含开站计划和晚班交接两页，使用不同内容的便签、独立文本、背景形状和内嵌路线占位图。页面为 1920×1080，案例日期固定，不覆盖 SDK 时钟。保留原生 Boards 编辑和样式。',
    },
    tryIt: {
      'en-US': [
      ...
      'zh-CN': [
        '拖拽人员便签，双击编辑原生文本；使用 Boards 工具栏和快捷键。',
  ...
  actions: [
    {
      id: 'native-edit',
      label: { 'en-US': 'Edit with native Board tools', 'zh-CN': '使用原生 Boards 工具编辑' },
      description: {
