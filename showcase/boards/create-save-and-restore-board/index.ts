...
const metadata: ShowcaseMetadata = {
  ...
  title: { 'en-US': 'Create, Save, and Restore a Canvas', 'zh-CN': '创建、保存与恢复 Canvases' },
  description: {
    'en-US':
    ...
    'zh-CN': '编辑野外站计划，保存完整 SDK 快照并重建 Canvases，比较活动页、层叠顺序、文本和变换。',
  },
  tags: { 'en-US': ['Canvases', 'Lifecycle', 'Snapshots'], 'zh-CN': ['Canvases', '生命周期', '快照'] },
  packages: ['@univerjs-pro/boards', '@univerjs-pro/boards-ui', '@univerjs-pro/license'],
  apis: [
    ['FUniver.createBoard()', 'Create a real canvas from an in-memory snapshot.', '从内存快照创建真实 Canvases。'],
    [
      'FBoard.save()',
  ...
  guide: {
    overview: {
      'en-US':
        'Tern field station has an opening plan and an evening handover, with distinct sticky notes, standalone text, a background shape and an embedded route placeholder image. The 1920×1080 page size and authored review date are fixed; the SDK clock is not overridden. Native Canvases editing and styles are retained.',
      'zh-CN':
        'Tern 野外站包含开站计划和晚班交接两页，使用不同内容的便签、独立文本、背景形状和内嵌路线占位图。页面为 1920×1080，案例日期固定，不覆盖 SDK 时钟。保留原生 Canvases 编辑和样式。',
    },
    tryIt: {
      'en-US': [
        'Drag crew stickies and double-click to edit their actual native text; use the Canvas toolbar and shortcuts.',
      ...
      'zh-CN': [
        '拖拽人员便签，双击编辑原生文本；使用 Canvases 工具栏和快捷键。',
  ...
  actions: [
    {
      id: 'native-edit',
      label: { 'en-US': 'Edit with native Canvas tools', 'zh-CN': '使用原生 Canvases 工具编辑' },
      description: {
