...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'text-box-insets-and-vertical-alignment'
  ...
  try {
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Text box layout demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
