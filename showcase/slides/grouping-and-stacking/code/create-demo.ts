...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  try {
    ...
    const grouped = presentation.getSlideById('grouped')!
    grouped.group(grouped.getElements().filter((element) => ['grouped-a', 'grouped-b'].includes(element.getId())))
