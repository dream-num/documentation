...
The native File menu registers Exchange and Slides Exchange client plugins;
Print registers the Slides Print plugin. Official plugin CSS is included in
both Preview and independent source. Menu registration/opening is not a
conversion round-trip or physical-print guarantee. No backend, booking,
...
preservation, File/Print settings and owned disposal. Text uses native
