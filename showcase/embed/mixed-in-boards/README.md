...
Start with the Board overview. Double-click a floating product for native editing
tools and use its native fullscreen action for detailed work. Return to the Board
to compare budget, narrative, review and evidence. The Board keeps its native
...
preview frame or standalone demo console. For the Board example, exit fullscreen
...
### 5. Workshop Board / Refine the discussion loop
...
clipped at the right preview edge. Base now sits on the left with enough room
