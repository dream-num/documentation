...
const metadata: ShowcaseMetadata = {
  ...
  title: {
    'en-US': 'Boards in Bases / Service Blueprint',
    'zh-CN': 'Boards 嵌入 Bases / 服务蓝图',
  },
  description: {
    'en-US':
  ...
  guide: {
    overview: {
      ...
      'zh-CN':
        'Cove 是虚构设备借用服务台，八条请求分布在四个阶段。原生 Boards 标签用十二张职责卡片和十七条绑定连接线，展示借用人、前台、后台三条泳道。蓝图说明预期交接，不是自动预约系统。',
    },
    tryIt: {
      'en-US': [
      ...
      'zh-CN': [
        ...
        '运行 README Boards 示例，尝试原生撤销重做、直接输入和方向键移动。',
        '返回 Requests 运行 Base 示例；Boards 应保持不变。',
        '在 Touchpoints 重命名 Reserve，检查三个关联标签，再返回 Boards 并切换主题。',
      ],
    },
    expected: {
      'en-US':
      ...
      'zh-CN':
        'Base 标签内原生 Boards 工具与真实形状绑定连接线，包含九份官方样式，无 fixture 面板。所选生产验证通过原生编辑及撤销重做、连接线渲染端点、关联标签与模型隔离；完整验收仍为部分覆盖。没有后端、预约或字段自动更新；刷新丢失修改，详见 README。',
    },
  },
  variants: [
