...
const metadata: ShowcaseMetadata = {
  ...
  description: {
    'en-US': 'A native Canvas tab compares three volume scenarios driven by shared Sheet assumptions.',
    'zh-CN': '原生 Canvas 标签页比较由共享 Sheet 假设驱动的三种数量情景。',
  },
  tags: {
    'en-US': ['Formula', 'Sheets', 'Canvases', 'Native tab', 'Print'],
    'zh-CN': ['公式', '表格', 'Canvases', '原生标签页', '打印'],
  },
  packages: [
    '@univerjs/sheets',
    '@univerjs-pro/boards',
  ...
  guide: {
    overview: {
      'en-US':
        'A making studio discusses unit contribution, volume and fixed cost. The Sheet owns six inputs; the Canvas compares scenarios without replacing authored notes.',
      'zh-CN': '制作工作室讨论单件贡献、数量和固定成本。Sheet 拥有六个输入，Canvas 比较情景而不替换手写说明。',
    },
    tryIt: {
      'en-US': [
        ...
        'Edit a Canvas note separately and preview source Sheet Print.',
      ],
      'zh-CN': [
        '切换 Assumptions 与 Sensitivity workshop。',
        '修改共享贡献或固定成本，再只修改一个情景系数。',
        '比较零值、空值和无效文本，修复来源缺失。',
        '独立编辑 Canvas 说明并预览源 Sheet 打印。',
      ],
    },
    expected: {
      'en-US':
  ...
  actions: [
    ...
    ['compare', 'Compare native Canvas scenarios', '比较原生 Canvases 情景'],
