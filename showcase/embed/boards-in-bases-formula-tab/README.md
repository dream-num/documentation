...
and thumbnails from the generic main-canvas focus switcher. Base table-list
...
EN/ZH packs cover the registered UI dependencies. Base uses Grid where applicable;
