...
const metadata: ShowcaseMetadata = {
  ...
  title: {
    'en-US': 'Relational Tables in Slides / Delivery Readiness',
    'zh-CN': 'Relational Tables 嵌入 Slides / 交付就绪评审',
  },
  description: {
    'en-US':
      'Keep seven release checks and three suppliers editable beside a reading-light delivery review, inside a native floating Relational Table.',
    'zh-CN': '在便携阅读灯交付评审旁，以原生浮动 Relational Table 编辑七项放行检查和三家供应商。',
  },
  tags: {
    'en-US': ['Embed', 'Slides', 'Relational Tables', 'Float', 'Readiness'],
    'zh-CN': ['嵌入', '幻灯片', 'Relational Tables', '浮动', '就绪评审'],
  },
  packages: [
    '@univerjs/core',
    '@univerjs-pro/slides',
  ...
  guide: {
    overview: {
      'en-US':
        'Solstice keeps the review narrative visible while a native floating Relational Table owns the checks, risk states and supplier links. Aubergine, pale yellow and mist blue distinguish decision context from evidence. This is a Float case, not the separate Relational Table Tab example.',
      'zh-CN':
        'Solstice 保留评审叙事，同时由原生浮动 Relational Table 管理检查、风险状态和供应商关联。深紫、浅黄和雾蓝区分决策背景与证据。这是 Float 案例，不是独立 Relational Table Tab 示例。',
    },
    tryIt: {
      'en-US': [
        ...
        'Edit Enclosure finish in the native Relational Table, or run the README Facade example. The floating Undo/Redo and fullscreen controls currently fail runtime gates; do not assume they restore edits.',
      ...
      'zh-CN': [
        ...
        '在原生 Relational Table 编辑 Enclosure finish，或运行 README 中的 Facade 示例。浮动菜单撤销重做和全屏当前未通过运行验收，不应假定它们能够恢复编辑。',
  ...
  states: [
    ...
    { id: 'child', label: { 'en-US': 'Active supplier Relational Table', 'zh-CN': '激活的供应商 Relational Table' } },
