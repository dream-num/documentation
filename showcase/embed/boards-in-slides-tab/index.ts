...
const metadata: ShowcaseMetadata = {
  ...
  category: 'features',
  previewHeight: 1100,
  group: { 'en-US': 'Slides host / Tab', 'zh-CN': 'Slides 宿主 / Boards 页' },
  title: { 'en-US': 'Boards in Slides / Retrospective Tab', 'zh-CN': 'Boards 嵌入 Slides / 复盘 Boards 标签' },
  description: {
    'en-US':
      'Switch from a facilitation deck to a full native Board page for nine editable observations and three visual themes.',
    'zh-CN': '从引导幻灯片切换到完整原生 Boards 页，编辑九张观察卡片并探索三个视觉分组。',
  },
  tags: {
    'en-US': ['Embed', 'Slides', 'Boards', 'Tab', 'Retrospective'],
    'zh-CN': ['嵌入', '幻灯片', '画板', '标签', '复盘'],
  },
  packages: [
    '@univerjs/core',
    '@univerjs-pro/slides',
  ...
  guide: {
    overview: {
      ...
      'zh-CN':
        'Kite 是虚构的 45 分钟志愿者复盘：七位参与者、九张原创观察卡片和三个拟议实验。原生 Boards 页位于开场与后续行动幻灯片之间。通过官方工具移动、编辑形状卡片，不添加通用测试面板或重复工具栏。',
    },
    tryIt: {
      'en-US': [
      ...
      'zh-CN': [
        ...
        '返回实验幻灯片，运行宿主 README 示例，然后切换主题并回到已编辑 Boards。',
      ],
    },
    expected: {
      'en-US':
      ...
      'zh-CN':
        '真正的 Slides 页面列表 Boards，不是 Float、iframe 或图片。宿主幻灯片使用 Grid，Boards 使用自己的原生工具。卡片是可编辑形状，不是投票应用或任务后端。幻灯片承诺独立，不使用公式关联。原生主题跟随可能重新生成 Boards 色表，但必须保留编写内容。刷新恢复初始数据；完整运行验收仍在进行，详见 README。',
    },
  },
  variants: [
  ...
  actions: [
    ['open', 'Open the full native Board page', '打开完整原生 Boards 页'],
    ['edit', 'Edit and move cards with native history', '编辑、移动卡片并使用原生历史'],
    ['navigate', 'Return to slides without replacing the Board', '返回幻灯片而不替换 Boards'],
  ].map(([id, en, zh]) => ({ id, label: { 'en-US': en, 'zh-CN': zh } })),
  states: [
    ['host', 'Facilitation slides', '引导幻灯片'],
    ['child', 'Active retrospective Board', '激活的复盘 Boards'],
