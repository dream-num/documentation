...
export const MEMO = [
  ...
  [
    'Open Changes in the native Base list to edit the source, then return to Release notes. Filtering the view does not filter these whole-table formulas. Changing an owner does not change completion; changing a hidden record can change a dependent count.',
    'body',
  ],
  [
