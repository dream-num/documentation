...
const metadata: ShowcaseMetadata = {
  ...
  title: { 'en-US': 'Modern Docs in Boards / Discovery Brief', 'zh-CN': '现代文档嵌入 Boards / 调研提纲' },
  description: {
    'en-US':
  ...
  guide: {
    ...
    tryIt: {
      'en-US': [
        ...
        'Return to the Board and change or move a card independently.',
      ],
      'zh-CN': [
        '双击提纲，激活原生 Docs 编辑。',
