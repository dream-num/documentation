...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'autofill-series'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('B5:B6').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'AutoFill demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
