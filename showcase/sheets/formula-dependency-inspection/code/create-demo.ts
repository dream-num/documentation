...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'formula-dependency-inspection'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('D12').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Dependency inspection demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
