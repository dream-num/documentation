...
const metadata = {
  ...
  description: {
    ...
    'zh-CN': '与 Luckysheet 相比，我们新设计的 Univer 在架构、数据结构和 API 等方面有了很大的改进，因此 Luckysheet 无法再 1:1 迁移到 Univer。但是，我们提供了一个迁移示例，帮助你了解如何将 Luckysheet 的功能迁移到 Univer。',
    'zh-TW': '與 Luckysheet 相比，我們新設計的 Univer 在架構、數據結構和 API 等方面有了很大的改進，因此 Luckysheet 無法再 1:1 遷移到 Univer。但是，我們提供了一個遷移示例，幫助你了解如何將 Luckysheet 的功能遷移到 Univer。',
