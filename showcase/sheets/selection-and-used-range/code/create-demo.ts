...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'selection-and-used-range'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('C5:E7').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Selection demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
