...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'database-formulas'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('H13').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Database formula demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
