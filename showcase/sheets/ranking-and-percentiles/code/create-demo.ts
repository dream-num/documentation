...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'ranking-and-percentiles'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('B7').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Ranking demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
