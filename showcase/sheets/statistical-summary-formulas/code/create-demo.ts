...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'statistical-summary-formulas'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('E7').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Statistical summary demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
