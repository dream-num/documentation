...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'text-cleaning-formulas'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('C5').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Text cleaning demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
