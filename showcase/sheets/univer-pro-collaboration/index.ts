...
const metadata = {
  ...
  description: {
    'en-US':
      'This example demonstrates how to enable collaborative editing in Univer Sheets, allowing multiple users to edit the same workbook and keep changes synchronized in real time.',
    ...
    'ja-JP':
      'この例では、Univer Sheets で共同編集を有効にし、複数のユーザーが同じワークブックを同時に編集して変更をリアルタイムに同期する方法を示します。',
  },
  tags: {
