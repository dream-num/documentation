...
export function createDemo(container: HTMLElement, darkMode = false) {
  ...
  root.className = 'indirect-offset-formulas'
  ...
  try {
    ...
    workbook.getActiveSheet()!.getRange('H5').activate()
    ...
    try {
      ...
      throw new AggregateError([error, cleanupError], 'Dynamic reference demo initialization and cleanup failed', {
        cause: error,
      })
    }
    throw error
