  ...
  sheets: {
    routes: {
      ...
      cellData: {
        ...
        2: { 0: { v: 'Edit B4: NORTH / EAST / EMPTY / MISSING / FAULT / TIMEOUT' } },
        ...
        17: { 0: { v: 'Numeric boundary gallery', s: 'header' }, 1: { v: 'Actual SDK result', s: 'header' } },
        18: { 0: { v: 'Blank range is ignored' }, 1: { f: '=CUSTOMSUM(G25:G27,5)' } },
        19: { 0: { v: 'Zero remains numeric' }, 1: { f: '=CUSTOMSUM(0,0)' } },
        20: { 0: { v: 'Negative + fractional' }, 1: { f: '=CUSTOMSUM(-2,0.5)' } },
        21: { 0: { v: 'Numeric text is rejected' }, 1: { f: '=CUSTOMSUM("12",5)' } },
        22: { 0: { v: 'Boolean is rejected' }, 1: { f: '=CUSTOMSUM(TRUE,5)' } },
        23: { 0: { v: 'Numeric overflow' }, 1: { f: '=CUSTOMSUM(1E308,1E308)' } },
      },
    },
  },
}
