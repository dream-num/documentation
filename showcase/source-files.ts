...
export function prepareShowcaseSource(files: Files, packageVersions: Record<string, string>) {
  ...
  source['/index.html'] ??=
    '<!doctype html>\n<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="icon" href="data:,"><title>Web SDK</title><style>html, body, #app { height: 100%; margin: 0; padding: 0; }</style></head><body><div id="app"></div><script type="module" src="/src/index.ts"></script></body></html>\n'
