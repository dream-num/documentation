...
Preview and standalone share one factory, four official SDK stylesheets and all five EN/ZH dependency packs. Initial language follows document.lang; theme changes preserve the current owner and edits. No backend, custom comparator or SDK modification is used.
