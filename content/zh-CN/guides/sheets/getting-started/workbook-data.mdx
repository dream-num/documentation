...
1. [使用 IWorkbookData 创建 Univer Sheets](/zh-CN/guides/sheets/features/core/sheet-api#create-worksheet)
2. [从 Univer Sheets 中保存 IWorkbookData](/zh-CN/guides/sheets/features/core/sheet-api#get-workbook-data)

`resources` 属性用于存储插件的数据。前往 [插件自定义模型](/guides/sheets/advanced/custom-model)
...
| cellData | `IObjectMatrixPrimitiveType<ICellData>` | 单元格内容的矩阵。[详情](/guides/sheets/getting-started/cell-data) |
