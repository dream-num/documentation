...
Univer 提供了协同编辑功能，支持多人同时编辑同一个文档。
...
import UniverPresetDocsCollaborationZhCN from '@univerjs/presets/preset-docs-collaboration/locales/zh-CN';
...
2. 通过 [导入插件](/zh-CN/guides/docs/features/import-export) 提供的 Facade API [`importDOCXToUnitIdAsync`](/zh-CN/guides/docs/features/import-export#import-docx-and-get-unitid) 方法，将 DOCX 文件导入到 Univer 服务。
