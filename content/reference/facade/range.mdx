...
| Method | Description |
|--------|-------------|
| [`addConditionalFormattingRule`](#addconditionalformattingrule) | Deprecated. Use the same API on `FWorksheet` |
| [`clearConditionalFormatRules`](#clearconditionalformatrules) | - |
| [`createConditionalFormattingRule`](#createconditionalformattingrule) | - |
| [`deleteConditionalFormattingRule`](#deleteconditionalformattingrule) | Deprecated. Use the same API on `FWorksheet` |
| [`getConditionalFormattingRules`](#getconditionalformattingrules) | - |
| [`moveConditionalFormattingRule`](#moveconditionalformattingrule) | Deprecated. Use the same API on `FWorksheet` |
| [`setConditionalFormattingRule`](#setconditionalformattingrule) | Deprecated. Use the same API on `FWorksheet` |
...
Deprecated. Use `FWorksheet.addConditionalFormattingRule` instead.
...
**Returns**
- `FRange` — The current range instance for chaining.
...
Deprecated. Use `FWorksheet.deleteConditionalFormattingRule` instead.
...
Deprecated. Use `FWorksheet.moveConditionalFormattingRule` instead.
...
- `toCfId` `string` — The target conditional formatting rule id.
- `type` `IAnchor['type']` *(optional)* — Move before or after the target rule.
...
Deprecated. Use `FWorksheet.setConditionalFormattingRule` instead.
...
**Parameters**
- `cfId` `string` — The conditional formatting rule id to update.
- `rule` `IConditionFormattingRule` — The replacement conditional formatting rule.
