...
Register the Exchange Client and Bases Exchange Client plugins and import both Facade entries. These methods require a matching conversion backend; see [Bases import/export](/guides/bases/features/import-export).
