...
- `calculationMode` `CalculationMode` — The calculation mode for formula initialization. See [`CalculationMode`](/reference/facade/enums#available-enum-names) for details.
