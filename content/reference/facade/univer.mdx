...
Register the matching history adapter before calling `compareUnitData()`. This API compares semantic content; it does not merge snapshots or replay mutations.
...
- `component` `ComponentType` — _No description_
