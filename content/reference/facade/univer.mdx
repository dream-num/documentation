...
| [`onBeforeCommandExecute`](#onbeforecommandexecute) | Register a callback that will be triggered before invoking a command |
| [`onCommandExecuted`](#oncommandexecuted) | Register a callback that will be triggered when a command is invoked |
...
<Callout type="warn">Deprecated — use `addEvent` instead.</Callout>
...
<Callout type="warn">Deprecated — use `univerAPI.addEvent(univerAPI.Event.BeforeCommandExecute, (event) =&gt; &#123;&#125;)` instead.</Callout>
...
<Callout type="warn">Deprecated — use `univerAPI.addEvent(univerAPI.Event.CommandExecuted, (event) =&gt; &#123;&#125;)` instead.</Callout>
...
**Parameters**
- `config` `IRegisterFunctionParams` — *No description*
