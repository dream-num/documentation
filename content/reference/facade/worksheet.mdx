...
| Method | Description |
|--------|-------------|
| [`getCharts`](#getcharts) | Returns an array of charts on this sheet |
| [`insertChart`](#insertchart) | Adds a new chart to this sheet |
| [`newChart`](#newchart) | Returns a builder to create a new chart for this sheet |
| [`registerChartTheme`](#registercharttheme) | Register your own chart theme |
| [`removeChart`](#removechart) | Removes a chart from the parent sheet |
| [`updateChart`](#updatechart) | Updates the chart on this sheet |
