...
<Callout type="warn">Deprecated — use `getRichText` instead</Callout>
...
<Callout type="warn">Deprecated — use `updateAsync` instead</Callout>
...
<Callout type="warn">Deprecated — use `deleteAsync` instead.</Callout>
...
<Callout type="warn">Deprecated — use `resolveAsync` instead</Callout>
