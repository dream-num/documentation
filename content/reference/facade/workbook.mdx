...
| Method | Description |
|--------|-------------|
| [`getAllFormulaError`](#getallformulaerror) | - |
...
| Method | Description |
|--------|-------------|
| [`navigateToSheetHyperlink`](#navigatetosheethyperlink) | - |

### @univerjs/sheets-numfmt

| Method | Description |
|--------|-------------|
| [`setNumfmtLocal`](#setnumfmtlocal) | - |
...
**Parameters**
- `hyperlink` `string` — *No description*
...
**Parameters**
- `locale` `INumfmtLocaleTag` — *No description*
