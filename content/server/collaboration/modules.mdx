...
the internal OT[^operational-transformation], protocol, or persistence implementation.
...
- submits changesets, performs OT, and advances continuous revisions[^collaboration-revision];
