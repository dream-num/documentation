...
icon: KeyRound
title: License
description: Obtain a Univer Office SDK license and configure it in your browser application.
---
...
Collaborative applications also configure the license in the browser. The browser example in [Collaboration Quick Start](/server/collaboration/quick-start) shows where to register the license plugin alongside collaboration plugins. Keep browser and server packages aligned with [SDK environment and version requirements](/server/requirements).
