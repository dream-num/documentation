...
Univer Office SDK includes [Web SDK](/guides/sheets) for embedded editors and headless[^headless-mode] content processing, [Server SDK](/server) for collaboration and file exchange, and [AI SDK](/ai) for agent workflows.
...
[^headless-mode]: Headless means operating on document content without mounting an interactive editor UI. It does not mean that collaboration, persistence, or file conversion services are included.
