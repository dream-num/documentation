...
- Middle content area: [`registerSheetMainExtension`](https://docs.univer.ai/reference/facade/univer#registersheetmainextension)
- Row header: [`registerSheetRowHeaderExtension`](https://docs.univer.ai/reference/facade/univer#registersheetrowheaderextension)
- Column header: [`registerSheetColumnHeaderExtension`](https://docs.univer.ai/reference/facade/univer#registersheetcolumnheaderextension)
...
<Callout>
  The zIndex for row and column header extensions must be greater than 10, and for middle content area extensions, it
  must be greater than 50, otherwise, they will be overridden.
</Callout>
