...
如果你还不知道 [Web SDK](/) 是什么：它是一个同构的全栈开发框架，支持在浏览器端和服务端创建与编辑电子表格和文档。它帮助开发者将 Office 应用无缝集成到各种 web 系统中，全面提升用户交互体验。Web SDK 的核心架构和功能已在 [GitHub 上开源](https://github.com/dream-num/univer)。
