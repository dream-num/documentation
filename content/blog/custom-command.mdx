...
<Callout>
  It is recommended to familiarize oneself with the [Univer command system](/blog/univer#command-system) before reading
  this section.
</Callout>
...
export class YourController extends Disposable {
  constructor(@ISheetClipboardService private readonly _sheetClipboardService: ISheetClipboardService) {
    super()
...
export interface ISheetClipboardHook {
   ...
   * @param row row of the copied cell
   * @param col col of the copied cell
   * @param rowSpan row span of the copied cell
   * @param colSpan col span of the copied cell
   * @return content
   */
   ...
   * @param row each row of the copied range
   * @return content
   */
...
export class YourController extends Disposable {
  constructor(@IAutoFillService private readonly _autoFillService: IAutoFillService) {
    super()
