...
2. 国际化文件
   ...
   位置在 [packages/sheets-formula-ui/src/locale/function-list/math/zh-CN.ts](https://github.com/dream-num/univer/blob/dev/packages/sheets-formula/src/locale/function-list/math/zh-CN.ts#L1043)。
