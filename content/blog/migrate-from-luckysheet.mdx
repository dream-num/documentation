...
The `transformExcelTolucky` method is provided in Luckyexcel, which can convert Excel files into JSON data. In the corresponding Univer, the [`importSheetToSnapshotAsync`](/guides/sheets/features/import-export#import-snapshot) method of Facade API can be used to achieve this.
