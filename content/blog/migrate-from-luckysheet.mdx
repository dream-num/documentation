...
| Floating Images        | [floating images](/guides/sheets/features/images)                                                                       | [image](https://dream-num.github.io/LuckysheetDocs/guide/sheet.html#image)                                                                                                                                                                                    |
...
| Comment / Annotation   | [thread comment](/guides/sheets/features/comments)                                                                      | [Cell Comments: cell.ps](https://dream-num.github.io/LuckysheetDocs/zh/guide/cell.html#%E5%9F%BA%E6%9C%AC%E5%8D%95%E5%85%83%E6%A0%BC)                                                                                                                         |
...
- Use Univer's dependency injection system to inject the plugin's service capabilities into the current Class. Refer to our [Plugin Tutorial](/blog/csv-import-plugin) to easily access the Univer dependency injection system
...
The `transformExcelTolucky` method is provided in Luckyexcel, which can convert Excel files into JSON data. In the corresponding Univer, the [`importSheetToSnapshotAsync`](/en-US/guides/sheets/features/import-export#import-xlsx-and-get-workbook-data) method of Facade API can be used to achieve this.

If you need to convert an online Excel file, Luckyexcel provides the `transformExcelToLuckyByUrl` method. In Univer, you can directly call the `importSheetToSnapshotAsync` method to achieve this.
