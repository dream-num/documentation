...
Luckyexcel 中提供了 `transformExcelTolucky` 方法，可以将 Excel 文件转换为 JSON 数据，对应的 Univer 中可以使用 Facade API 的 [`importSheetToSnapshotAsync`](/guides/sheets/features/import-export#import-snapshot) 方法来实现。
