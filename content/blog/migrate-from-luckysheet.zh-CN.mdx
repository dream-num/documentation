...
| 浮动图片    | [floating images](/guides/sheets/features/images)                                                                 | [image](https://dream-num.github.io/LuckysheetDocs/zh/guide/sheet.html#image)                                                                                                                                                                                                            |
...
| 评论 / 批注 | [thread comment](/guides/sheets/features/comments)                                                                | [单元格批注：cell.ps](https://dream-num.github.io/LuckysheetDocs/zh/guide/cell.html#%E5%9F%BA%E6%9C%AC%E5%8D%95%E5%85%83%E6%A0%BC)                                                                                                                                                       |
...
- 采用 Univer 的依赖注入系统，将插件的 service 能力注入到当前 Class 中，参考我们的 [插件教程](/blog/csv-import-plugin) 可以轻松的接入 Univer 依赖注入系统
...
Luckyexcel 中提供了 `transformExcelTolucky` 方法，可以将 Excel 文件转换为 JSON 数据，对应的 Univer 中可以使用 Facade API 的 [`importSheetToSnapshotAsync`](/zh-CN/guides/sheets/features/import-export#import-xlsx-and-get-workbook-data) 方法来实现。

如果需要转换一个在线的 Excel 文件，Luckyexcel 中提供了 `transformExcelToLuckyByUrl` 方法，Univer 中可以直接调用 `importSheetToSnapshotAsync` 方法来实现。
