...
To achieve these goals, we introduced various [mechanisms](/blog/univer), such as the plugin system, dependency injection, and a command system. However, these mechanisms also introduced some side effects: the complexity of directly using Univer's low-level APIs made development less accessible, which conflicted with our goal of providing a "great developer experience."
