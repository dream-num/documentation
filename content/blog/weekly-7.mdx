...
- Added new permission points: `WorkbookInsertColumnPermission`, `WorkbookInsertRowPermission`, `WorkbookDeleteColumnPermission`, and `WorkbookDeleteRowPermission`, allowing control over adding and deleting columns and rows in worksheets.
