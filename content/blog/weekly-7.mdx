...
### `univer.registerPlugins`: Support for Batch Plugin Registration

Use [`univer.registerPlugins`](/guides/sheets/getting-started/installation#registerPlugin) to register multiple plugins at once without multiple calls. For example:
