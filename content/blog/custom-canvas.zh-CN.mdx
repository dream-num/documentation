...
- 中间内容区域：[`registerSheetMainExtension`](https://docs.univer.ai/reference/facade/univer#registersheetmainextension)
- 行标题：[`registerSheetRowHeaderExtension`](https://docs.univer.ai/reference/facade/univer#registersheetrowheaderextension)
- 列标题：[`registerSheetColumnHeaderExtension`](https://docs.univer.ai/reference/facade/univer#registersheetcolumnheaderextension)
...
<Callout>行标题、列标题的扩展 zIndex 必须大于 10，中间内容区域的扩展 zIndex 必须大于 50，否则会被覆盖。</Callout>
