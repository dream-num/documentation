...
本周我们在文档中新增了[《生命周期》](/guides/sheets/getting-started/life-cycle)的章节，以及增加了如何[编写 UI 适配器来支持自定义 Vue 2.x 组件](https://docs.univer.ai/guides/sheets/ui/components#vue-2x)。
...
新增的[生命周期章节](/guides/sheets/getting-started/life-cycle)简单介绍了 Univer 的生命周期设计，包括各个阶段的含义和开发者如何利用生命周期事件来控制功能加载和执行时机。通过该章节，你可以了解到如何寻找合适的时机来执行你的业务逻辑。
