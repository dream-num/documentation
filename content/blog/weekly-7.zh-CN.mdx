...
在 Univer v0.10.0 版本中，我们提供了新的 [`mergeLocales`](/guides/sheets/getting-started/i18n#mergeLocales) 方法。用于合并多个语言包对象。相比以往手动调用 `merge` 进行合并，`mergeLocales` 让你无需再关心底层的合并细节，只需专注于传入需要合并的语言包即可，大幅提升了国际化开发的便捷性和代码可读性。
