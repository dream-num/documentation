...
Make sure you have a basic understanding of the [plugin mechanism](/blog/univer#plugins).
...
export class UniverSheetsCustomMenuPlugin extends Plugin {
  ...
  override onRendered(): void {
    touchDependencies(this._injector, [[CustomMenuController]])
  }
}
```
...
export class CustomMenuController extends Plugin {
  private _initCommands(): void {
    ;[SingleButtonOperation].forEach((c) => {
