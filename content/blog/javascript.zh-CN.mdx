---
title: 在 JavaScript 中扩展 Univer
author: Univer Engineering Team
date: 2025-07-02
---

<Callout>
  如果发现在部分集成了 TypeScript 支持的项目中，装饰器并没有正常工作的话（通常可能是因为 babel 相关的装饰器插件实现与
  TypeScript 的不一致），也可以考虑使用这种方式来替代装饰器。
</Callout>
...
参考 [redi 文档](https://redi.wzhu.dev/docs/env)。
