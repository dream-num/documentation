...
<Callout>了解 Univer 架构的 [分层模型](/blog/univer#以分层架构划分模块)。</Callout>
...
<Callout>了解 [快照](/introduction/concepts#快照) 的概念。</Callout>
...
<Callout>阅读 [命令系统](/blog/univer#命令系统) 了解什么是命令以及命令的三种类型。</Callout>
...
<Callout>关于 Univer 的生命周期机制，请查看文档 [插件生命周期](/blog/univer#插件生命周期)。</Callout>
