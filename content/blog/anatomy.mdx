...
<Callout>
  First-party plugins of Univer refer to the [OOXML specification](https://ecma-international.org/publications-and-standards/standards/ecma-376/) when defining snapshot data structures to facilitate import and export.
</Callout>
