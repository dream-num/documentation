...
<Callout>Learn about Univer's [layered model](/blog/univer#hierarchical-structure).</Callout>
...
<Callout>Learn about the concept of [snapshots](/guides/sheets/getting-started/quickstart#snapshot).</Callout>
