...
![Golden 4 metrics](@/content/guides/shared/getting-started/pro/sre-manual/golden-4-metrics.png)

2. component performance and availability from server side

- RDS

![RDS metrics](@/content/guides/shared/getting-started/pro/sre-manual/rds-metrics.png)

- Redis&MQ

![Redis and MQ metrics](@/content/guides/shared/getting-started/pro/sre-manual/redis-and-mq.png)

3. business metrics of Collaborative editing

![Collaborative editing metrics](@/content/guides/shared/getting-started/pro/sre-manual/collaboration-edit-metrics.png)

4. If you enable USIP integration, you can observe the technical metrics from the Univer service side

![USIP metrics](@/content/guides/shared/getting-started/pro/sre-manual/usip-metrics.png)
...
![Loki search](@/content/guides/shared/getting-started/pro/sre-manual/loki-search.png)
