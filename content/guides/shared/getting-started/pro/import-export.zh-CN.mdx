...
4. 如果你想得到 json 数据而不是 unit 文档，请使用 `import.jsonID` 调获取文件接口下载转换结果。注意得到 json 数据后，还需要 [转换一下](/zh-CN/guides/docs/features/import-export#服务端数据转化) 才能使用到 Univer 中。

![import](@/content/guides/shared/getting-started/pro/import-export/import.png)
...
![import](@/content/guides/shared/getting-started/pro/import-export/export.png)

## API

查看 [Univer Server API 定义](/zh-CN/guides/docs/getting-started/pro/api)
