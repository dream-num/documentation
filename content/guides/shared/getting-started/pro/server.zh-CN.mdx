...
请参考 [Univer Server 配置要求](/zh-CN/guides/docs/getting-started/pro/introduction#%E7%8E%AF%E5%A2%83%E8%A6%81%E6%B1%82)，以确保你的运行环境可以满足运行 Univer 后端服务的要求。

<Callout>
  未经授权的 Univer 后端服务使用功能受限的体验版本，如果你想要不受限制地使用后端服务，请前往章节[许可证](/zh-CN/guides/docs/getting-started/pro/license)。
</Callout>
...
<Cards>
  <Card title="USIP" href="/zh-CN/guides/docs/getting-started/pro/usip">
    已实现部分接口
  </Card>
  <Card title="Univer 事件同步" href="/zh-CN/guides/docs/getting-started/pro/event-sync">
    已支持部分事件
  </Card>
  <Card title="OpenAPI">
    设计中，后续逐步推出
...
![Univer Pro 集成架构](@/content/guides/shared/getting-started/pro/server/integration-arch.png)
