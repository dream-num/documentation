...
![event-sync](@/content/guides/shared/getting-started/pro/event-sync/event-sync.png)
...
Add these configs below to your customer config file, go to [Deploy to product environment](/en-US/guides/docs/getting-started/pro/deploy) to learn how to add customer config file.
