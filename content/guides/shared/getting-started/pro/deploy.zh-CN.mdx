...
![部署架构及服务介绍](@/content/guides/shared/getting-started/pro/deploy/deploy-arch.png)
...
这个在[通过 Univer 事件同步机制与你的系统集成](/zh-CN/guides/docs/getting-started/pro/event-sync)中已描述配置项的意义，这里不再重复，如果你需要启用，可如下配置：
