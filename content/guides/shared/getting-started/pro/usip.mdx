...
![Interaction flow](@/content/guides/shared/getting-started/pro/usip/credential.png)
...
![Interaction flow](@/content/guides/shared/getting-started/pro/usip/user-infos.png)
...
![Interaction flow](@/content/guides/shared/getting-started/pro/usip/user-role.png)
...
![Interaction flow](@/content/guides/shared/getting-started/pro/usip/list-collaborators.png)
