...
![交互流程](@/content/guides/shared/getting-started/pro/usip/credential.png)
...
![交互流程](@/content/guides/shared/getting-started/pro/usip/user-infos.png)
...
![交互流程](@/content/guides/shared/getting-started/pro/usip/user-role.png)
...
![交互流程](@/content/guides/shared/getting-started/pro/usip/list-collaborators.png)
...
**请注意**，一旦你配置了开启 USIP，上述的所有 4 个 USIP API 的 url 都需要配置，并且需要你的服务正确实现。如何在部署的时候应用这些配置请参考[生产部署](/zh-CN/guides/docs/getting-started/pro/deploy)。
