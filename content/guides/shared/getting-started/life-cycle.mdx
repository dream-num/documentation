...
<Callout>
  To learn more about the lifecycle design of Univer and the specific startup timing of plugins, you can find relevant information in [《Univer Architecture#Plugin Lifecycle》](/guides/recipes/architecture/univer#plugin-life-cycle).
</Callout>
