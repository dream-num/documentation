...
<Callout>
  For more design details, please read [Univer Command System](/en-US/guides/recipes/architecture/univer#command-system).
</Callout>
...
- [Extending Canvas](/en-US/guides/recipes/practices/custom-canvas)
- [Custom Theme](/en-US/guides/recipes/practices/custom-theme)
...
<Callout>
  If you want to reuse the algorithm provided by the formula system and enhance the capability of the formula algorithm, you can register a custom formula through plug-in configuration. For detailed tutorials, please refer to [Custom Formula](/en-US/guides/recipes/tutorials/custom-formula).
</Callout>
