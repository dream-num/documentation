...
Reference: [`univerAPI.openSidebar`](https://docs.univer.ai/reference/facade/open-sidebar)
...
Reference: [`univerAPI.openDialog`](https://docs.univer.ai/reference/facade/open-dialog)
