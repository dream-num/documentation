...
PDFs supports Worker[^web-worker] rendering of page thumbnails. Pass `thumbnailWorkerURL` to `UniverPdfsUIPlugin`; the Worker uses `OffscreenCanvas`. This setting does not move the whole PDF editor into a Worker.
