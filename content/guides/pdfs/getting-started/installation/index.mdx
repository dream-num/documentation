...
Node.js services can register `UniverPdfsPlugin` and `UniverPdfEditorPlugin` without browser UI packages. Add the collaboration client only when the service needs to load or synchronize persisted PDF units.
