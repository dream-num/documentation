...
Follow [Collaboration integration](/server/collaboration/browser-integration) to run the official example, connect your application, and verify persistence and authorization. Implementation details and runnable Web/Server examples are maintained at [Collaboration Quick Start](/server/collaboration/quick-start).
