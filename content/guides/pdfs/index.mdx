...
Univer PDFs is the PDF product in Web SDK. It represents a PDF as a formal `UNIVER_PDF` unit, preserves the imported source document, and stores accepted edits in a separate durable edit layer. The browser UI renders both layers as one continuous document.
