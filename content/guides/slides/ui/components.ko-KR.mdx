---
title: 사용자 정의 컴포넌트
description: Univer SDK는 사용자 정의 컴포넌트를 통합하는 여러 방법을 제공하여 기능을 확장하고 맞춤 설정할 수 있도록 합니다. 이 가이드에서는 자주 사용하는 몇 가지 방법을 소개합니다.
icon: Component
---
...
상단 메뉴 모음(Ribbon)과 오른쪽 클릭 메뉴(Context Menu) 모두에 사용자 지정 컴포넌트를 넣을 수 있습니다. 자체 플러그인에서 메뉴 항목을 제공하고, 사용 전에 컴포넌트를 등록하며, 플러그인과 함께 등록도 해제하세요.
