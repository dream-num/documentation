...
If you are not familiar with how to obtain an instance of the Facade API, you can refer to [Facade API](/guides/slides/getting-started/facade).
...
The top menu bar (Ribbon) and right-click menu (Context Menu) can both include custom components. Contribute those menu items from your own plugin, register their components before use, and dispose the registrations with the plugin.
