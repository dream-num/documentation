...
Use [`order`, `gridLayout`, and `updateMenuConfig()`](/guides/slides/features/core#menu-order-and-grid-layout) to configure tab, group, and item order, grid placement, and runtime updates. The guide also links to the custom-menu Facade options.
