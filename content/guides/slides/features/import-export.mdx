...
`@univerjs-pro/slides-exchange-client` depends on `@univerjs-pro/exchange-client`. Put server URLs on the shared exchange client, then register the Slides client to add PPTX menu operations.
