...
- `@univerjs-pro/slides-table-ui` adds browser editing UI, render integration, selection behavior, and context menu operations. It also provides `@univerjs-pro/slides-table-ui/locale/*`, `@univerjs-pro/slides-table-ui/facade`, and `@univerjs-pro/slides-table-ui/lib/index.css`.
