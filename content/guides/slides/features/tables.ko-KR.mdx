  ...
  meta={{
    ...
    plugins: [
      ...
      },
      {
        ...
        locale: '@univerjs-pro/slides-table-ui/locale/ko-KR',
...
- `@univerjs-pro/slides-table-ui`는 브라우저 편집 UI, 렌더링 통합, 선택 동작, 컨텍스트 메뉴 작업을 추가합니다. 또한 `@univerjs-pro/slides-table-ui/locale/*`와 `@univerjs-pro/slides-table-ui/lib/index.css`도 제공합니다.
