  ...
  meta={{
    ...
    plugins: [
      ...
      },
      {
        ...
        locale: '@univerjs-pro/slides-history-ui/locale/en-US',
      },
    ],
    license: true,
    server: true,
...
Complete [collaboration integration](/server/collaboration/browser-integration) and [license configuration](/guides/license). Verify that two sessions can edit the same Slides document and that changes survive a reload.
