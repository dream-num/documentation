...
The side-effect import `@univerjs-pro/slides/facade` extends `FUniver` with the Slides API:
...
Use Facade methods or commands to update a running presentation. Do not mutate the saved snapshot directly.
