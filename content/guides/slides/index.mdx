...
<Callout type="info">
  Univer Slides is provided in the `@univerjs-pro` package scope. Configure a [client license](/server/license) for licensed features. Add [Univer Server SDK](/server) when your application needs collaboration or file conversion.
</Callout>
