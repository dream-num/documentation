...
Univer Slides is the presentation product in Web SDK. It is used to build slide deck editors, presentation viewers, import/export flows, and server-side slide processing on top of the Web SDK runtime.
...
<Callout type="info">
  Univer Slides now lives in the `@univerjs-pro` package scope. Use [Web SDK](/server) for license and deployment
