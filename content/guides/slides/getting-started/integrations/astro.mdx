...
Start with [installation and basic usage](/guides/slides/getting-started/installation). This example uses Astro to mount Univer Slides in a container with an explicit height.
