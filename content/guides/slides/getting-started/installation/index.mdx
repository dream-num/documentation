...
This chapter introduces the installation and basic usage of Univer Slides. This guide uses the Univer Pro Slides packages. There is currently no Slides preset, so create the application in plugin mode.
