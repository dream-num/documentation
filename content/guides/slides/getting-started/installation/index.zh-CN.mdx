...
本章介绍 Univer Slides 的安装与基本使用。本指南使用 Univer SDK Pro 的 Slides 包。目前没有 Slides 预设，因此需要通过插件模式创建 Slides 应用。
...
- 在 [使用 Univer SDK Pro](/guides/slides/getting-started/pro) 中了解授权和部署要求。
