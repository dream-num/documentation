...
This chapter introduces the installation and basic usage of Univer Slides. Unlike Univer Sheets and Univer Docs, Slides is currently distributed as a Univer Pro product and does not provide a preset mode. You need to create a Slides application with plugin mode.
...
`univer.registerPlugin` registers a plugin on the Univer instance. You can call it once per plugin, or pass an array to register multiple plugins in one place.
