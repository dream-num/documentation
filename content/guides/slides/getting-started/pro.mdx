...
Some Pro capabilities require a Univer SDK Pro Server deployment, especially import/export, storage, conversion, and collaboration-related workflows. See [Univer SDK Pro Server](/guides/pro/server) before connecting these capabilities to production traffic.
...
For information on how to license Univer SDK Pro, see the [Univer SDK Pro pricing page](/guides/pro).
