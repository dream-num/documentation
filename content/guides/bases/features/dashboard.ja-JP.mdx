...
ダッシュボードとピボットビューは `getPermission()` を公開しており、個別に読み取り専用を設定できます。[権限](/guides/bases/features/core/permissions)を参照してください。API 全体は [Bases Facade](/reference/facade/base) に記載されています。
