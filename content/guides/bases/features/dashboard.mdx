...
Dashboards and pivot views expose `getPermission()` for individual read-only settings; see [Permissions](/guides/bases/features/core/permissions). See [Bases Facade](/reference/facade/base) for the full API.
