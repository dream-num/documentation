...
대시보드와 피벗 뷰는 개별 읽기 전용 설정을 위한 `getPermission()`을 제공합니다. [권한](/guides/bases/features/core/permissions)을 참고하세요. 전체 API는 [Bases Facade](/reference/facade/base)에서 확인할 수 있습니다.
