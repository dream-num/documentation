...
Complete [collaboration integration](/server/collaboration/browser-integration) and [license configuration](/server/license). Verify that two sessions can edit the same Bases document and that changes survive a reload.
