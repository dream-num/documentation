...
2. Add Collaboration Client configuration to your existing Bases editor. Follow [Collaboration Quick Start](/server/collaboration/quick-start) for browser setup, but create and store Bases documents instead of copying the example's Sheets data.
