...
在开始之前，请确保你：
- 在你的项目中集成 Univer 高级功能。如果你还未完成集成，请参考[集成 Univer 高级功能](/en-US/guides/pro)。
- 对于服务端部署，已完成 Docker 或 Kubernetes 环境的配置。如果你尚未完成配置，请参考 [Docker 部署文档](/zh-CN/guides/pro/deploy#deploy-to-docker-compose) 或 [Kubernetes 部署文档](/zh-CN/guides/pro/deploy#deploy-to-k8s)。
