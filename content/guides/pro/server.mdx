...
Please refer to [Univer Server Configuration Requirements](/en-US/guides/pro#evironment-requirements) to ensure that your runtime environment meets the requirements for running the Univer backend service.

<Callout>
  The unauthorized Univer backend service provides a limited-feature trial version. If you want to use the backend service without restrictions, please refer to the [License](/en-US/guides/pro/license) section.
</Callout>
