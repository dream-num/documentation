...
- For server-side deployment, you have completed the configuration of Docker or Kubernetes environment. If you haven't completed the configuration, please refer to the [Docker Deployment Documentation](/en-US/guides/pro/deploy#deploy-to-docker-compose) or [Kubernetes Deployment Documentation](/en-US/guides/pro/deploy#deploy-to-k8s).
