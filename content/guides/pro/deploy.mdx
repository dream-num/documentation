...
Univer's installation configuration is disabled by default. You need to decide whether to enable it based on your usage needs. For related instructions, please refer to [Integrating USIP with Your System](/en-US/guides/pro/usip).
...
The meaning of the configuration item has been described in [Integrate with your system via USIP(/en-US/guides/pro/usip), If you need to enable it, you can configure it as follows:
...
The meaning of the configuration items has been described in [Integrate with your system via Univer event synchronization mechanism](/en-US/guides/pro/event-sync). If you need to enable it, you can configure it as follows:
