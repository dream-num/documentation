...
const T: Record<Locale, {
  ...
  'ko-KR': {
    ...
    multiDocRatio: '다중 사용자 문서 비율',
    avgCollaborators: '문서당 평균 협업자 수',
    collaboratorsSuffix: '명',
    redundancy: '이중화 계수',
    redundancySuffix: '배',
    spec: '서비스 사양',
    spec2c4g: '2c4g(일반 규모)',
    ...
    postgresql: 'PostgreSQL',
    postgresqlDescBaseline: '편집 QPS ≤ 1000 기준 구성',
    postgresqlDescUpgrade: '편집 QPS > 1000이면 업그레이드를 권장',
    notes: '계산 참고 사항',
  ...
  'fr-FR': {
    ...
    saveIntervalSuffix: 's',
    multiDocRatio: 'Proportion de documents multi-utilisateurs',
    avgCollaborators: 'Nombre moyen de collaborateurs par document',
    collaboratorsSuffix: 'utilisateurs',
    redundancy: 'Facteur de redondance',
    redundancySuffix: 'x',
    spec: 'Configuration d’instance',
    spec2c4g: '2c4g (standard)',
    spec4c8g: '4c8g (grande échelle)',
    editQps: 'QPS de sauvegarde des modifications',
    broadcastQps: 'QPS de diffusion collaborative',
    ...
    postgresql: 'PostgreSQL',
    postgresqlDescBaseline: 'Configuration de référence pour un QPS de modification ≤ 1000',
    postgresqlDescUpgrade: 'Mise à niveau recommandée lorsque le QPS de modification > 1000',
  ...
  'ru-RU': {
    ...
    multiDocRatio: 'Доля многопользовательских документов',
    avgCollaborators: 'Среднее число участников на документ',
    collaboratorsSuffix: 'пользователей',
    redundancy: 'Коэффициент резервирования',
    redundancySuffix: '×',
    spec: 'Конфигурация экземпляра',
    spec2c4g: '2c4g (стандартная)',
    spec4c8g: '4c8g (крупный масштаб)',
    editQps: 'QPS сохранения изменений',
    broadcastQps: 'QPS совместной рассылки',
    ...
    postgresql: 'PostgreSQL',
    postgresqlDescBaseline: 'Базовая конфигурация для QPS изменений ≤ 1000',
    postgresqlDescUpgrade: 'При QPS изменений > 1000 рекомендуется обновление',
    notes: 'Примечания к расчёту',
