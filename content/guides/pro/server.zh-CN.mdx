...
请参考 [Univer Server 配置要求](/zh-CN/guides/pro#evironment-requirements)，以确保你的运行环境可以满足运行 Univer 后端服务的要求。

<Callout>
  未经授权的 Univer 后端服务使用功能受限的体验版本，如果你想要不受限制地使用后端服务，请前往章节[许可证](/zh-CN/guides/pro/license)。
</Callout>
