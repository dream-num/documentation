...
Univer Boards is the canvas product in Univer Office SDK. It is used when the document is no longer a grid, a page, or a slide deck, but a free-form workspace: whiteboards, diagrams, sticky notes, connectors, embedded tables, and mind maps all belong here.
...
To get started, check out the [Quick Start](/guides/boards/getting-started/installation) guide.
