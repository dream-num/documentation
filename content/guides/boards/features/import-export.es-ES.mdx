...
Para exportar PPTX, integra un backend de conversión con [Univer Server SDK](/server/import-export) y verifica su compatibilidad con snapshots Board. Configura la [licencia del cliente](/server/license) por separado; registrar un plugin del navegador no proporciona API de conversión.
