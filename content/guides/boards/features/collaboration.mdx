...
Let multiple users edit the same board and see each other's changes. Complete [collaboration integration](/server/collaboration/browser-integration) for the backend, authentication, permissions, and storage, then configure the [license](/guides/license).
