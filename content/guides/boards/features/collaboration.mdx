...
Add Collaboration Client configuration to your existing Boards editor using the [Collaboration Quick Start](/server/collaboration/quick-start). That example uses Sheets; your backend must create and persist a Boards document and return its ID to the browser.
