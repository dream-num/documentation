...
The model facade provides `createBoard`, `getActiveBoard`, `getBoard`, and element/container operations. The UI facade adds settings, search, focus, and viewport APIs to `FBoard`. Continue with the [Boards Facade API guide](/guides/boards/getting-started/facade) and [Board Data Structure](/guides/boards/model/board-data).
