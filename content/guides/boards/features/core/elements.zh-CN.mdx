...
如果要创建带边框的分组或泳道，请继续阅读[容器与泳道](/guides/boards/features/core/containers)。另请参考 [Boards facade API](/reference/facade/board) 和 [Board 元素数据模型](/guides/boards/model/board-elements)。
