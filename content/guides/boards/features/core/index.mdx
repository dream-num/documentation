...
Univer Boards core combines a page-and-element model with an interactive browser canvas. The model and UI are delivered by two Univer SDK Pro packages and operate as an independent `UNIVER_BOARD` unit.
