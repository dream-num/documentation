...
Сначала прочитайте [установку и базовую настройку](/guides/boards/getting-started/installation). В этом примере Vue монтирует Univer Boards в контейнер с явно заданной высотой.
