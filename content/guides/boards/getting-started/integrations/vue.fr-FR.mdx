...
Consultez d’abord [l’installation et les premiers pas](/guides/boards/getting-started/installation). Cet exemple utilise Vue pour monter Univer Boards dans un conteneur avec une hauteur explicite.
