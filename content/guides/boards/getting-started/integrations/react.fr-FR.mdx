...
Consultez d’abord [l’installation et les premiers pas](/guides/boards/getting-started/installation). Cet exemple utilise React pour monter Univer Boards dans un conteneur avec une hauteur explicite.
