...
Before officially starting to write code, it is recommended that you study [Formula Architecture](/guides/recipes/architecture/formula) to have a comprehensive understanding of the formula system.
