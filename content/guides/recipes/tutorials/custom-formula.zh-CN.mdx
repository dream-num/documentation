...
2. 定义国际化
    ...
    定义你所需要的国际化内容，详细的字段说明请参考 [如何在 Formula Engine 中添加公式](/guides/recipes/tutorials/custom-formula#how-to-add-formulas-in-formula-engine) 的部分。同样的，多个公式就用公式名称作为 `key` 值区分。
...
正式着手写代码之前，推荐大家先学习 [公式的架构](/guides/recipes/architecture/formula)，对公式系统有一个全面的了解。
