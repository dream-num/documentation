...
<Callout type="info" emoji="ℹ️">
  It is recommended to familiarize oneself with the [Univer command system](/en-US/guides/recipes/architecture/univer#command-system) before reading this section.
</Callout>
