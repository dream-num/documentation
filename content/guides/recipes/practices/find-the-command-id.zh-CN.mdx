...
例如，你想要查找设置选区下划线的命令 ID，首先可以在 [API Reference - Variable: SetRangeUnderlineCommand](/reference/packages/plugins/univerjs/sheets-ui) 中找到。然后就可以这样导入并获取命令 ID：
...
如果你对 [Univer 的架构](/guides/recipes/architecture/univer)所有了解，应该能非常轻松地在源码中寻找到命令的 ID。
