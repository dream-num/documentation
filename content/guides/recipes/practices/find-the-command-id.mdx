...
If you are familiar with the [architecture of Univer](/guides/recipes/architecture/univer), you should be able to easily find the ID of a command in the source code.
