...
For more information about the lifecycle of the plugin, you can check [Plugin Lifecycle](/guides/recipes/architecture/univer#plugin-life-cycle) for more information.
...
- [Plugin Lifecycle](/guides/recipes/architecture/univer#plugin-life-cycle)
