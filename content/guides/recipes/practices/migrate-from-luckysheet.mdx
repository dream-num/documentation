...
- Use Univer's dependency injection system to inject the plugin's service capabilities into the current Class. Refer to our [Plugin Tutorial](/guides/recipes/practices/csv-import-plugin) to easily access the Univer dependency injection system
