...
<Callout>
  We use the dependency injection tool [redi](https://redi.wzhu.dev/) in Univer, you can refer to the redi documentation to understand the basic concepts of dependency injection and how to use it.
</Callout>
...
- [Formula](/guides/recipes/architecture/formula)
- [Rendering](/guides/recipes/architecture/rendering)
- [Web Worker](/guides/recipes/architecture/web-worker)
