...
<Callout>
  我们使用的依赖注入工具为 [redi](https://redi.wzhu.dev/)，可以参考 redi 的文档了解依赖注入的基本概念，以及如何使用它。redi 还有一篇详细介绍依赖注入原理的[博客](https://redi.wzhu.dev/blogs/di)，强烈推荐阅读。
</Callout>
...
- [公式系统](/guides/recipes/architecture/formula)
- [渲染系统](/guides/recipes/architecture/rendering)
