...
[`order`、`gridLayout`、`updateMenuConfig()`](/guides/sheets/features/core#menu-order-and-grid-layout) でタブ・グループ・項目の順序、グリッド配置、実行時の更新を設定できます。ガイドにはカスタムメニューの Facade オプションへのリンクもあります。
