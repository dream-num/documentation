...
如果您擁有 Univer 的商業授權，請參閱[在用戶端中使用授權](/guides/server-integration/license#in-preset-mode)進行配置。
...
如果您擁有 Univer 的商業授權，請參閱[在用戶端中使用授權](/guides/server-integration/license#in-plugin-mode)進行配置。
