...
Univer 상용 라이선스가 있다면 [클라이언트에서 라이선스 사용](/server/license#in-preset-mode)을 참고하여 구성하세요.
...
Univer 상용 라이선스가 있다면 [클라이언트에서 라이선스 사용](/server/license#in-plugin-mode)을 참고하여 구성하세요.
