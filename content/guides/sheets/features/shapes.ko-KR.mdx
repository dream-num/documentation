...
Univer 상용 라이선스가 있다면 [클라이언트에서 라이선스 사용](/guides/license#in-preset-mode)을 참고하여 설정하세요.
...
Univer 상용 라이선스가 있다면 [클라이언트에서 라이선스 사용](/guides/license#in-plugin-mode)을 참고하여 설정하세요.
