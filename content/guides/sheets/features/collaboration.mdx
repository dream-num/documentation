...
- You can import a `.xlsx` file into the Univer server using the `FUniver.importXLSXToUnitIdAsync` method provided by the [Import Plugin](/en-US/guides/sheets/features/import-export).
