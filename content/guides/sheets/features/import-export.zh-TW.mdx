...
<Callout title="為什麼 Univer SDK 透過後端服務實現匯入匯出？">
...
透過選單欄的匯入入口成功匯入後，頁面左下角會彈出提示框，顯示匯入成功的資訊，並提供訪問匯入文件的連結。若預設的匯入匯出行為無法滿足你的需求，請檢視[《自訂匯入文件》](/blog/custom-import)以瞭解如何自訂匯入行為。
