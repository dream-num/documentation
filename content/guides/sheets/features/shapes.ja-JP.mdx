...
Univer の商用ライセンスをお持ちの場合は、[クライアントでのライセンス利用](/guides/license#in-preset-mode) を参照して設定してください。
...
Univer の商用ライセンスをお持ちの場合は、[クライアントでのライセンス利用](/guides/license#in-plugin-mode) を参照して設定してください。
