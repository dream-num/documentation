...
<Callout type="warning" title="Migration note">
  The package-root helpers `transformSnapshotJsonToWorkbookData` and `transformWorkbookDataToSnapshotJson` have been removed. Import `@univerjs-pro/exchange-client/facade` and use the Facade APIs below.
</Callout>
