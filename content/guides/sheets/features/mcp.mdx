...
MCP (Model Context Protocol) integration enables large language models to securely operate Univer spreadsheets through standardized protocols, supporting various AI clients like Cursor, Claude, and more. With MCP protocol, you can directly manipulate spreadsheets using natural language instructions, such as "populate sales data in cells A1 to C10", and AI will automatically execute the corresponding operations.
