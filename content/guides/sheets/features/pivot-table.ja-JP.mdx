...
Univer の商用ライセンスをお持ちの場合は、設定方法について [クライアントでのライセンス](/guides/server-integration/license#in-preset-mode) を参照してください。
...
Univer の商用ライセンスをお持ちの場合は、設定方法について [クライアントでのライセンス](/guides/server-integration/license#in-plugin-mode) を参照してください。
...
| [setValueFilter](https://docs.univer.ai/reference/facade/pivot-table#setValueFilter)             | 値フィルターを設定します                                                                    |
