...
| メソッド                                                                                                                       | 説明                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| [remove](https://docs.univer.ai/reference/facade/pivot-table#remove)                             | ピボットテーブルをインスタンスから削除します                                               |
...
| [reset](https://docs.univer.ai/reference/facade/pivot-table#reset)                               | ピボットテーブルのフィールドをリセットします                                               |
