...
Univer の商用ライセンスをお持ちの場合は、設定方法について [クライアントでのライセンス](/guides/license#in-preset-mode) を参照してください。
...
Univer の商用ライセンスをお持ちの場合は、設定方法について [クライアントでのライセンス](/guides/license#in-plugin-mode) を参照してください。
