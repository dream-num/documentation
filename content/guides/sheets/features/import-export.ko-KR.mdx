...
<Callout type="warning" title="Migration note">
  패키지 루트의 `transformSnapshotJsonToWorkbookData` 및 `transformWorkbookDataToSnapshotJson` 헬퍼는 제거되었습니다. `@univerjs-pro/exchange-client/facade`를 가져오고 아래 Facade API를 사용하세요.
</Callout>
