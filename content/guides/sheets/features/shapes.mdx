...
Use [`FWorksheet.newShape`](/reference/facade/f-worksheet-shape-mixin#newshape) to create a shape builder, then call [`FWorksheet.insertShape`](/reference/facade/f-worksheet-shape-mixin#insertshape) to insert it.
...
Use [`FWorksheet.newConnector`](/reference/facade/f-worksheet-shape-mixin#newconnector) to create connector lines, and [`FWorksheet.connectShapes`](/reference/facade/f-worksheet-shape-mixin#connectshapes) to attach both ends to shape connection sites.
...
Use [`FWorksheet.updateShape`](/reference/facade/f-worksheet-shape-mixin#updateshape) to update an existing shape and [`FWorksheet.removeShape`](/reference/facade/f-worksheet-shape-mixin#removeshape) to remove it.
...
- [`FShape`](/reference/facade/f-shape): shape builder and shape instance methods.
- [`FConnectorShape`](/reference/facade/f-connector-shape): connector-specific methods (arrow and relation data).
- [`FShapeEnum`](/reference/facade/f-shape-enum): shape-related enums exposed on `univerAPI.Enum`.
- [`FWorksheetShapeMixin`](/reference/facade/f-worksheet-shape-mixin): worksheet-level shape operations.
