...
<Callout type="warning" title="Note">
  The Live Share feature requires Univer Server support. Please ensure you have correctly installed and configured the Univer Server. For details, please refer to: [License](/server/license)
</Callout>
