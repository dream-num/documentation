...
<Callout type="warning" title="Note">
  The Live Share feature requires Univer Server support. Please ensure you have correctly installed and configured the Univer Server. For details, please refer to: [Using Univer SDK Pro](/guides/sheets/getting-started/pro)
</Callout>
...
If you have a Univer commercial license, please refer to [Using License in Client](/guides/server-integration/license#in-plugin-mode) for configuration.
