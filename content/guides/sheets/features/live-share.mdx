...
<Callout type="warning" title="Note">
  The Live Share feature requires Univer Server support. Please ensure you have correctly installed and configured the Univer Server. For details, please refer to: [License](/guides/license)
</Callout>
...
If you have a Univer commercial license, please refer to [Using License in Client](/guides/license#in-plugin-mode) for configuration.
