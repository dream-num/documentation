...
如果你拥有 Univer 的商业许可证，请参考[在客户端使用许可证](/guides/server-integration/license#in-preset-mode)进行配置。
...
如果你拥有 Univer 的商业许可证，请参考[在客户端使用许可证](/guides/server-integration/license#in-plugin-mode)进行配置。
...
| [setValueFilter](https://docs.univer.ai/reference/facade/pivot-table#setValueFilter)             | 设置值维度                                                              |
