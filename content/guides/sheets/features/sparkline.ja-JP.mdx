...
Univer に商用ライセンスをお持ちの場合は、設定方法については [クライアントでのライセンスの使用](/guides/server-integration/license#in-preset-mode) を参照してください。
...
Univer に商用ライセンスをお持ちの場合は、設定方法については [クライアントでのライセンスの使用](/guides/server-integration/license#in-plugin-mode) を参照してください。
