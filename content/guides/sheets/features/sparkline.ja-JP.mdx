...
`@univerjs-pro/sheets-graphics` は、スパークライン UI が使用するセル内グラフィックスのレンダリング層を提供します。
...
[`FSparklineGroup`](https://docs.univer.ai/reference/facade/sparkline) インスタンスは、スパークライングループを操作する次のメソッドを持ちます:
