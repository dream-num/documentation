...
<MetaData
  ...
  meta={{
    preset: [{
      ...
      locale: '@univerjs/preset-sheets-note/locales/ja-JP',
    ...
    plugins: [{
      ...
      locale: '@univerjs/sheets-note-ui/locale/ja-JP',
...
import UniverPresetSheetsNoteJaJP from '@univerjs/preset-sheets-note/locales/ja-JP' // [!code ++]
...
const { univerAPI } = createUniver({
  ...
  locales: {
    [LocaleType.JA_JP]: mergeLocales(
      ...
      UniverPresetSheetsNoteJaJP, // [!code ++]
    ),
  },
  presets: [
...
import SheetsNoteUIJaJP from '@univerjs/sheets-note-ui/locale/ja-JP' // [!code ++]
...
範囲の左上のセルの備考を取得するには、`FRange.getNote` を使用します。
