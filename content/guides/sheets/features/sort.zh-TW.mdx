...
[`FWorksheet.sort(colIndex, asc)`](https://docs.univer.ai/reference/facade/worksheet#sort) 方法可以按指定的列對工作表進行排序。
...
[`FRange.sort(column)`](https://docs.univer.ai/reference/facade/range#sort) 方法可以按指定的列和順序對給定範圍內的單元格進行排序。
