...
Если у вас есть коммерческая лицензия Univer, инструкции по настройке см. в разделе [Использование лицензии на клиенте](/guides/server-integration/license#in-preset-mode).
...
Если у вас есть коммерческая лицензия Univer, инструкции по настройке см. в разделе [Использование лицензии на клиенте](/guides/server-integration/license#in-plugin-mode).
...
Эта возможность доступна только при наличии [лицензии](/guides/server-integration/license). Для пользователей без лицензии действуют ограничения, а операция сохранения возвращает `false`.
...
Эта возможность доступна только при наличии [лицензии](/guides/server-integration/license). Для пользователей без лицензии действуют ограничения. При ошибке операция сохранения возвращает `false`, а при успехе — строку изображения в формате base64.
