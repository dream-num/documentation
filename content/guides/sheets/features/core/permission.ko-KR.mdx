...
<Callout>
  공동 작업자 관리는 앱의 사용자·ACL 모델과 권한 서비스에서 구현합니다. [Identity and authorization](https://office.univer.ai/collaboration/identity-and-authorization)에 따라 읽기, JOIN, 수정을 보호하세요. 아래 프런트엔드 API에는 대응하는 권한 서비스 구현이 필요합니다.
</Callout>
