...
The [`IWorkbookData`](/en-US/guides/sheets/model/workbook-data) is an object that contains the configuration information of the workbook.
...
Reference: [Permission](/en-US/guides/sheets/features/core/permission)

### Formula

Reference: [Formula](/en-US/guides/sheets/features/core/formula)

### Row and Column

Reference: [Row and Column](/en-US/guides/sheets/features/core/row-col)

### Range

Reference: [Range](/en-US/guides/sheets/features/core/range-selection#range)

### Selection

Reference: [Selection](/en-US/guides/sheets/features/core/range-selection#selection)

### Cell

Reference: [Cell](/en-US/guides/sheets/features/core/range-selection#cell)

### Freeze

Reference: [Freeze](/en-US/guides/sheets/features/core/freeze)

### Integrating Custom Components into Univer

Reference: [Integrating Custom Components into Univer](/en-US/en-US/guides/sheets/ui/components)
