...
The [`univerAPI.createWorkbook(data, options)`](https://docs.univer.ai/reference/facade/univer#createworkbook) method creates and returns the `FWorkbook` object.

The [`IWorkbookData`](/guides/sheets/model/workbook-data) is an object that contains the configuration information of the workbook.
...
### Get Workbook Data [#get-workbook-data]
...
<Callout type="warning">
  ...
  Also, please note that `univer` and `univerAPI` are different instances. For instructions on how to obtain these instances, refer to the [Installation & Basic Usage](/guides/sheets/getting-started/installation).
</Callout>
...
The following example shows how to create a worksheet using the [`FWorkbook.create`](https://docs.univer.ai/reference/facade/workbook#create) method.
...
Reference: [Permission](/guides/sheets/features/core/permission)

### Formula

Reference: [Formula](/guides/sheets/features/core/formula)

### Row and Column

Reference: [Row and Column](/guides/sheets/features/core/row-col)

### Range

Reference: [Range](/guides/sheets/features/core/range-selection#range)

### Selection

Reference: [Selection](/guides/sheets/features/core/range-selection#selection)

### Cell

Reference: [Cell](/guides/sheets/features/core/range-selection#cell)

### Freeze

Reference: [Freeze](/guides/sheets/features/core/freeze)

### Integrating Custom Components into Univer

Reference: [Integrating Custom Components into Univer](/en-US/guides/sheets/ui/components)
