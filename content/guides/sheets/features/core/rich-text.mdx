...
有两种方式可以设置单元格的富文本：[`setRichTextValueForCell`](https://reference.univer.ai/en-US/classes/FRange#setrichtextvalueforcell) 和 [`setRichTextValues`](https://reference.univer.ai/en-US/classes/FRange#setrichtextvalues)。
