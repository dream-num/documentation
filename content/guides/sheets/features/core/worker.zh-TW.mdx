...
更多預設模式示例可以參考 [Univer preset examples](https://github.com/dream-num/univer/tree/dev/examples/src/preset-sheets-core-with-worker)。這些示例展示了不同 preset 組合下的 Worker 配置方式，適合作為基於預設集成 Univer 時的參考。
