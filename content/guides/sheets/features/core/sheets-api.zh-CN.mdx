...
[`IWorkbookData`](/zh-CN/guides/sheets/model/workbook-data) 是一个对象，包含了工作簿的配置信息。
...
参考：[权限控制](/zh-CN/guides/sheets/features/core/permission)

### 公式

参考：[公式](/zh-CN/guides/sheets/features/core/formula)

### 行列操作

参考：[行列操作](/zh-CN/guides/sheets/features/core/row-col)

### 范围 Range

参考：[范围 Range](/zh-CN/guides/sheets/features/core/range-selection#range)

### 选区 Selection

参考：[选区 Selection](/zh-CN/guides/sheets/features/core/range-selection#selection)

### 单元格 Cell

参考：[单元格 Cell](/zh-CN/guides/sheets/features/core/range-selection#cell)

### 冻结

参考：[冻结](/zh-CN/guides/sheets/features/core/freeze)

### 集成自定义组件

参考：[集成自定义组件](/zh-CN/guides/sheets/ui/components)
