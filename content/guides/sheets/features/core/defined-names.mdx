...
`FWorkbook.newDefinedNameBuilder()` creates a defined name builder, returning an `FDefinedNameBuilder` instance. You can use method chaining to generate an `ISetDefinedNameMutationParam` object for creating defined names.

Following are some member methods of [`FDefinedNameBuilder`](https://docs.univer.ai/reference/facade/defined-name):
...
[`FWorkbook.insertDefinedNameBuilder()`](https://docs.univer.ai/reference/facade/workbook#insertdefinednamebuilder) method can be used to create a defined name that is available for the entire workbook.
...
[`FWorkbook.insertDefinedName()`](https://docs.univer.ai/reference/facade/workbook#insertdefinedname) method can be used to quickly create a defined name.
...
Other methods:
- [`FWorksheet.insertDefinedName()`](https://docs.univer.ai/reference/facade/worksheet#insertdefinedname): Creates a defined name that is available for a specific worksheet.

### Get Defined Names

[`FWorkbook.getDefinedName()`](https://docs.univer.ai/reference/facade/workbook#getdefinedname) method can be used to get a defined name in the workbook, returning an `FDefinedName` instance.
...
Other methods:
- [`FWorkbook.getDefinedNames()`](https://docs.univer.ai/reference/facade/workbook#getdefinednames) method can be used to get all defined names in the workbook, returning an array of `FDefinedName[]`.
- [`FWorksheet.getDefinedNames()`](https://docs.univer.ai/reference/facade/worksheet#getdefinednames) method can be used to get all defined names available for this worksheet, returning an array of `FDefinedName[]`.

### Modify Defined Names

[`FWorkbook.updateDefinedNameBuilder()`](https://docs.univer.ai/reference/facade/workbook#updatedefinednamebuilder) method can be used to modify a defined name in the workbook.
...
[`FDefinedName`](https://docs.univer.ai/reference/facade/defined-name) instance can also be used to directly modify the defined name configuration.
...
[`FWorkbook.deleteDefinedName()`](https://docs.univer.ai/reference/facade/workbook#deletedefinedname) method can be used to delete a defined name in the workbook.
...
You can also directly delete the defined name using the returned [`FDefinedName`](https://docs.univer.ai/reference/facade/defined-name) instance.
