...
セルにリッチテキストを設定する方法は2通りあります（[`setRichTextValueForCell`](https://docs.univer.ai/reference/facade/range#setrichtextvalueforcell) と [`setRichTextValues`](https://docs.univer.ai/reference/facade/range#setrichtextvalues)）。
