...
For more Preset Mode examples, see [Univer preset examples](https://github.com/dream-num/univer/tree/0d849012594882307186f33734b8b89d80a729e9/examples/src/preset-sheets-core-with-worker). These examples show Worker configuration with different preset combinations and are useful references when integrating Univer through presets.
