...
<Callout type="info" emoji="ℹ️">
  Cell operations can be regarded as operations on a range of rows and columns with a height of 1 and a width of 1. For the operation range, please refer to [Range](/guides/sheets/features/core/range-selection#range).
</Callout>
