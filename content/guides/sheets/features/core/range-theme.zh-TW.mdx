...
為了豐富表格的展示效果，我們提供了一些預設的區域主題，也開放了定製主題的能力，供 Univer 使用者使用。
...
Univer 除了內建主題， 還提供了自定義主題的能力，你可以透過以下 API 來自定義主題：
...
Univer 主題的核心類 [`RangeThemeStyle`](https://github.com/dream-num/univer/blob/dev/packages/sheets/src/model/range-theme-util.ts#L110) 上提供提供了以下屬性供使用者自定義主題：
