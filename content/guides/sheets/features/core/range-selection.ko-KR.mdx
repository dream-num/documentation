...
2. Univer API 플러그인은 확장된 셀 속성도 `Workbook`의 `resources` 속성에 저장합니다. 자세한 내용은 [플러그인 사용자 지정 모델](/blog/custom-model)을 참고하세요.
...
`registerCellCustomRender`는 셀의 사용자 지정 렌더러를 등록합니다.
