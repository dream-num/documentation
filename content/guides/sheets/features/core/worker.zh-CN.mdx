...
更多预设模式示例可以参考 [Univer preset examples](https://github.com/dream-num/univer/tree/0d849012594882307186f33734b8b89d80a729e9/examples/src/preset-sheets-core-with-worker)。这些示例展示了不同 preset 组合下的 Worker 配置方式，适合作为基于预设集成 Univer 时的参考。
