...
<thead>
  <tr>
    <th style={{ width: '200px' }}>API メソッドの説明</th>
    <th>移行ガイド</th>
  </tr>
</thead>
<tbody>
  <tr>
    ...
    <td>
      ...
      <p>
        **新しい API：**<br/>
        ワークブック：`FWorkbook.getWorkbookPermission()` <br/>
        ワークシート：`FWorksheet.getWorksheetPermission()` <br/>
        範囲：`FRange.getRangePermission()`
      </p>
    </td>
  </tr>
  <tr>
    <td>ワークブック権限ポイントの設定</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **旧 API：**<br/>
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        **新しい API：**<br/>
        ワークシート：`FWorksheetPermission.protectRanges(configs)` <br/>
        範囲：`FRangePermission.protect(options?: IRangeProtectionOptions)`
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <p>
        **新しい API：**<br/>
        ワークシート：`FWorksheetPermission.unprotectRules(ruleIds: string[])` <br/>
        範囲：`FRangePermission.unprotect()` <br/>
        範囲権限ルール：`FRangeProtectionRule.remove()`
      </p>
    </td>
  </tr>
  <tr>
