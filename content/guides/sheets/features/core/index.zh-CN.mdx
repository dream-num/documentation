...
参考：[@univerjs/preset-sheets-core](/zh-CN/reference/packages/presets/univerjs/preset-sheets-core)
...
参考：[@univerjs/engine-render](/zh-CN/reference/packages/plugins/univerjs/engine-render)

#### @univerjs/engine-formula

本插件是 Univer 的公式引擎，负责公式的计算和处理。其提供了 `UniverFormulaEnginePlugin` 插件。

参考：[@univerjs/engine-formula](/zh-CN/reference/packages/plugins/univerjs/engine-formula)
...
参考：[@univerjs/ui](/zh-CN/reference/packages/plugins/univerjs/ui)

#### @univerjs/docs

本插件是 Univer Docs 的核心插件。其提供了 `UniverDocsPlugin` 插件。

参考：[@univerjs/docs](/zh-CN/reference/packages/plugins/univerjs/docs)

#### @univerjs/docs-ui

本插件是 Univer Docs 的 UI 插件，包含了文档编辑器的 UI 组件和交互。其提供了 `UniverDocsUIPlugin` 插件。

参考：[@univerjs/docs-ui](/zh-CN/reference/packages/plugins/univerjs/docs-ui)
...
参考：[@univerjs/sheets](/zh-CN/reference/packages/plugins/univerjs/sheets)
...
参考：[@univerjs/sheets-ui](/zh-CN/reference/packages/plugins/univerjs/sheets-ui)
