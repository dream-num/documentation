...
有兩種方式可以設定單元格的富文字：[`setRichTextValueForCell`](https://reference.univer.ai/zh-TW/classes/FRange#setrichtextvalueforcell) 和 [`setRichTextValues`](https://reference.univer.ai/zh-TW/classes/FRange#setrichtextvalues)。
