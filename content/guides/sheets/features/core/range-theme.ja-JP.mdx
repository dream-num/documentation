...
Univer テーマのコアクラスである [`RangeThemeStyle`](https://github.com/dream-num/univer/blob/dev/packages/sheets/src/models/range-theme-util.ts#L110) は、テーマをカスタマイズするために以下のプロパティを提供します。
