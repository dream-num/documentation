...
[`IWorksheetData.freeze`](/en-US/guides/sheets/model/workbook-data) can be used to configure the freeze state of a worksheet. Its interface definition is as follows:
