...
<thead>
  <tr>
    <th style={{ width: '200px' }}>API 方法描述</th>
    <th>遷移指南</th>
  </tr>
</thead>
<tbody>
  <tr>
    ...
    <td>
      ...
      <p>
        **新 API：**<br/>
        工作簿：`FWorkbook.getWorkbookPermission()` <br/>
        工作表：`FWorksheet.getWorksheetPermission()` <br/>
        選區：`FRange.getRangePermission()`
      </p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        **新 API：**<br/>
        工作表：`FWorksheetPermission.protectRanges(configs)` <br/>
        選區：`FRangePermission.protect(options?: IRangeProtectionOptions)`
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <p>
        **新 API：**<br/>
        工作表：`FWorksheetPermission.unprotectRules(ruleIds: string[])` <br/>
        選區：`FRangePermission.unprotect()` <br/>
        范围保护规则：`FRangeProtectionRule.remove()`
      </p>
    </td>
  </tr>
  <tr>
