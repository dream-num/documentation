...
<MigrationTable headers={['API Method Description', 'Migration Guide']}>
  <MigrationRow method="Get Permission Instance">
    ...
    <MigrationCell>
      ...
      <br />
      Workbook: <code>FWorkbook.getWorkbookPermission()</code>
      <br />
      Worksheet: <code>FWorksheet.getWorksheetPermission()</code>
      <br />
      Range: <code>FRange.getRangePermission()</code>
    </MigrationCell>
  </MigrationRow>
  ...
  <MigrationRow method="Set Range Protection Permission">
    ...
    <MigrationCell>
      <strong>New API:</strong>
      <br />
      Worksheet: <code>FWorksheetPermission.protectRanges(configs)</code>
      <br />
      Range: <code>FRangePermission.protect(options?: IRangeProtectionOptions)</code>
    </MigrationCell>
  </MigrationRow>
  <MigrationRow method="Remove Range Protection Permission">
    ...
    <MigrationCell>
      <strong>New API:</strong>
      <br />
      Worksheet: <code>FWorksheetPermission.unprotectRules(ruleIds: string[])</code>
      <br />
      Range: <code>FRangePermission.unprotect()</code>
      <br />
      Range Protection Rule: <code>FRangeProtectionRule.remove()</code>
    </MigrationCell>
  </MigrationRow>
