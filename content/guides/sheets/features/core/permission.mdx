...
<Callout>
  Collaborator management belongs to your application and permission service. Connect your user/ACL model and enforce server-side read, JOIN, and edit policies; see [identity and authorization](https://office.univer.ai/collaboration/identity-and-authorization). The frontend APIs below require a matching permission-service implementation and do not automatically configure server authorization.
</Callout>
