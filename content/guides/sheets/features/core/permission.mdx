...
<thead>
  <tr>
    <th style={{ width: '200px' }}>API Method Description</th>
    <th>Migration Guide</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td>Get Permission Instance</td>
    <td>
      ...
      <p>
        **New API:**<br/>
        Workbook: `FWorkbook.getWorkbookPermission()` <br/>
        Worksheet: `FWorksheet.getWorksheetPermission()` <br/>
        Range: `FRange.getRangePermission()`
      </p>
    </td>
  </tr>
  <tr>
    <td>Set Workbook Permission Point</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Get Workbook Permission Point Status</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Set Workbook Edit Permission</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Add Worksheet Protection</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Remove Worksheet Protection</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Set Worksheet Permission Point</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Get Worksheet Permission Point Status</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Get Permission Info of Specific Cell</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Set Range Protection Permission</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
      ...
      <p>
        **New API:**<br/>
        Worksheet: `FWorksheetPermission.protectRanges(configs)` <br/>
        Range: `FRangePermission.protect(options?: IRangeProtectionOptions)`
      </p>
    </td>
  </tr>
  <tr>
    <td>Remove Range Protection Permission</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
      ...
      <p>
        **New API:**<br/>
        Worksheet: `FWorksheetPermission.unprotectRules(ruleIds: string[])` <br/>
        Range: `FRangePermission.unprotect()` <br/>
        Range Protection Rule: `FRangeProtectionRule.remove()`
      </p>
    </td>
  </tr>
  <tr>
    <td>Set Range Protection Permission Point</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Update Range Protection Permission Ranges</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
  ...
  <tr>
    <td>Remove Permission Dialog</td>
    <td>
      <p style={{ marginBottom: '10px' }}>
        **Old API:**<br/>
