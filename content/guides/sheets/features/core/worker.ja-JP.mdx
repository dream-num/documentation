...
プリセットモードのその他の例は、[Univer の preset examples](https://github.com/dream-num/univer/tree/dev/examples/src/preset-sheets-core-with-worker) を参照してください。これらの例では、異なる preset の組み合わせにおける Worker 設定方法を確認でき、preset を使って Univer を統合する際の参考になります。
