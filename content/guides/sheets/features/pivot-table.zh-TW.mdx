...
資料透視表支援多個值維度，同時可以定製多值維度所在區域（value position）和位置（value index）。
...
[`FWorkbook.addPivotTable`](https://reference.univer.ai/zh-TW/classes/FWorkbook#addpivottable) 方法用於新增透視表，成功會返回 `FPivotTable` 例項。
...
[`FWorkbook.getPivotTableByCell`](https://reference.univer.ai/zh-TW/classes/FWorkbook#getpivottablebycell) 方法透過錨定單元格獲取透視表例項。如果目標單元格在透視表中，它將返回 `FPivotTable` 例項。
...
[`FPivotTable`](https://reference.univer.ai/zh-TW/classes/FPivotTable) 例項中有一些方法，可以用來操作透視表。

| 方法                                                                                                                           | 描述                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [remove](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#remove)                             | 刪除透視表例項                                                          |
| [getConfig](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#getconfig)                       | 獲取當前透視表的配置資訊，其中包括資料來源範圍，錨定單元格， 維度配置資訊      |
| [addField](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#addfield)                         | 新增一個維度                                                            |
| [removeField](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#removefield)                   | 刪除一個維度                                                            |
| [updateFieldPosition](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#updatefieldposition)   | 更新維度的所在區域以及順序                                               |
...
| [setSubtotalType](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#setsubtotaltype)           | 設定彙總方式                                                            |
| [setLabelSort](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#setlabelsort)                 | 設定標籤排序                                                            |
| [setLabelManualFilter](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#setlabelmanualfilter) | 設定標籤篩選                                                            |
| [renameField](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#renamefield)                   | 重新命名維度                                                              |
| [setValueFilter](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#setValueFilter)             | 設定值維度                                                              |
| [reset](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#reset)                               | 重置透視表的維度配置                                                    |
| [setFieldsConfig](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#setfieldsconfig)           | 設定透視表的維度配置                                                    |
| [getValueFilters](https://reference.univer.ai/@univerjs-pro/sheets-pivot/facade/classes/FPivotTable#getvaluefilters)           | 獲取透視表的值維度配置                                                  |
