...
Univer の商用ライセンスをお持ちの場合は、[クライアントでのライセンス使用](/server/license#in-plugin-mode)を参照して設定してください。
...
Univer の商用ライセンスをお持ちの場合は、[クライアントでのライセンス使用](/server/license#in-preset-mode)を参照して設定してください。
