...
Univer 상용 라이선스가 있다면 구성 방법은 [클라이언트에서 라이선스 사용하기](/guides/server-integration/license#in-preset-mode)를 참고하세요.
...
Univer 상용 라이선스가 있다면 구성 방법은 [클라이언트에서 라이선스 사용하기](/guides/server-integration/license#in-plugin-mode)를 참고하세요.
