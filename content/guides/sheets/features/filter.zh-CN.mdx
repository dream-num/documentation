...
<MetaData
  ...
  meta={{
    ...
    plugins: [{
      ...
      locale: '@univerjs/sheets-filter/locale/zh-CN',
    }, {
...
interface IUniverSheetsFilterConfig {
   ...
   * 如果设置为 defaultValue 对象，则会显示筛选器同步开关，其初始状态将由 defaultValue 属性决定。
   * @default false
   */
...
返回一个 [`FFilter`](https://docs.univer.ai/reference/facade/filter) 对象，若 sheet 没有筛选器，则返回 `null`。

- `FWorksheet` 对象上的 [`getFilter()`](https://docs.univer.ai/reference/facade/worksheet#getfilter)
- `FRange` 对象上的 [`getFilter()`](https://docs.univer.ai/reference/facade/range#getfilter)
...
创建一个 [`FFilter`](https://docs.univer.ai/reference/facade/filter) 对象，若 sheet 已经有筛选器，则返回 `null`。

- `FRange` 对象上的 [`createFilter()`](https://docs.univer.ai/reference/facade/range#createfilter)
...
[`FFilter.remove()`](https://docs.univer.ai/reference/facade/filter#remove) 方法移除筛选器。
...
[`FFilter.setColumnFilterCriteria(column, criteria)`](https://docs.univer.ai/reference/facade/filter#setcolumnfiltercriteria) 方法设置指定列的筛选条件。
...
- [`FFilter.removeColumnFilterCriteria(column)`](https://docs.univer.ai/reference/facade/filter#removecolumnfiltercriteria) 方法移除指定列的筛选条件。
- [`FFilter.removeFilterCriteria()`](https://docs.univer.ai/reference/facade/filter#removefiltercriteria) 方法移除所有列的筛选条件。
...
[`FFilter.getFilteredOutRows()`](https://docs.univer.ai/reference/facade/filter#getfilteredoutrows) 方法返回一个数组，包含被筛选掉的行的索引。
