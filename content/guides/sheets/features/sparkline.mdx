...
`@univerjs-pro/sheets-graphics` provides the in-cell graphics render layer used by the sparkline UI.
...
[`FSparklineGroup`](https://docs.univer.ai/reference/facade/sparkline) instance has the following methods to manipulate the sparkline group:
