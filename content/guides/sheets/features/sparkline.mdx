...
[`FWorksheet.addSparkline`](https://docs.univer.ai/reference/facade/worksheet#addsparkline) method is used to add a sparkline in the specified range, returning an `FSparkline` instance.
...
[`FWorksheet.composeSparkline`](https://docs.univer.ai/reference/facade/worksheet#composesparkline) and [`FWorksheet.unComposeSparkline`](https://docs.univer.ai/reference/facade/worksheet#uncomposesparkline) methods are used to compose and uncompose sparklines.
...
[`FWorksheet.getSparklineByCell`](https://docs.univer.ai/reference/facade/worksheet#getsparklinebycell) is used to get the sparkline instance in a specified cell, returning an `FSparkline` instance.
...
[`FWorksheet.getSparklineGroupByCell`](https://docs.univer.ai/reference/facade/worksheet#getsparklinegroupbycell) is used to get the sparkline group instance in a specified cell, returning an `FSparklineGroup` instance.
...
[`FSparkline`](https://docs.univer.ai/reference/facade/sparkline) instance has the following methods to manipulate the sparkline:
...
[`FSparklineGroup`](/reference/facade/sparkline-group) instance has the following methods to manipulate the sparkline group:
...
Use `FSparklineGroup.setConfig()` to configure colors and display options for the entire group. Set both `seriesColor` and `themeType: SparklineThemeTypeEnum.CUSTOM` for custom colors. See [sparkline group configuration](/reference/facade/sparkline-group) for the complete option table and example, including point markers, axes, extrema, empty values, hidden cells and line width.
