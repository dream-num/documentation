...
<MetaData
  ...
  meta={{
    ...
    plugins: [{
      ...
      locale: '@univerjs-pro/edit-history-loader/locale/ja-JP',
    }, {
      client: '@univerjs-pro/edit-history-viewer',
      locale: '@univerjs-pro/edit-history-viewer/locale/ja-JP',
...
import EditHistoryViewerJaJP from '@univerjs-pro/edit-history-viewer/locale/ja-JP' // [!code ++]
