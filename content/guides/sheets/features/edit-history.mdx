...
Complete [collaboration integration](/server/collaboration/browser-integration) and [license configuration](/guides/license). Verify that two sessions can edit the same Sheets document and that changes survive a reload.
