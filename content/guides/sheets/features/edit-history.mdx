  ...
  meta={{
    ...
    plugins: [
      ...
      },
      {
        ...
        locale: '@univerjs-pro/sheets-history-ui/locale/en-US',
...
Complete [collaboration integration](/server/collaboration/browser-integration) and [license configuration](/server/license). Verify that two sessions can edit the same Sheets document and that changes survive a reload.
