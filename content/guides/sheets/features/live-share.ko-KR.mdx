...
<Callout type="warning" title="Note">
  실시간 공유 기능을 사용하려면 Univer Server가 필요합니다. Univer Server가 올바르게 설치되고 구성되었는지 확인하세요. 자세한 내용은 [Univer SDK Pro 사용하기](/guides/sheets/getting-started/pro)를 참고하세요.
</Callout>
...
Univer 상용 라이선스가 있다면 [클라이언트에서 라이선스 사용하기](/guides/server-integration/license#in-plugin-mode)를 참고하여 구성하세요.
