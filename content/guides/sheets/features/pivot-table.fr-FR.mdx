...
Si vous disposez d’une licence commerciale Univer, consultez la page [Utiliser une licence dans le client](/guides/server-integration/license#in-preset-mode) pour la configurer.
...
Si vous disposez d’une licence commerciale Univer, consultez la page [Utiliser une licence dans le client](/guides/server-integration/license#in-plugin-mode) pour la configurer.
