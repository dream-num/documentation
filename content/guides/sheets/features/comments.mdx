...
If you are using the [collaboration](/en-US/guides/sheets/features/collaboration) feature with `UniverSheetsCollaborationPreset`, make sure to pass the `collaboration: true` option in `UniverSheetsThreadCommentPreset`:
...
If you are using the [collaboration](/en-US/guides/sheets/features/collaboration) feature, configure it as follows:
