...
完整的配置項參考 [`IUniverSheetsDataValidationPresetConfig`](https://github.com/dream-num/univer-presets/tree/dev/packages/preset-sheets-data-validation)。
...
以下是 [`FDataValidationBuilder`](https://docs.univer.ai/reference/facade/data-validation) 上的一些成員方法：
