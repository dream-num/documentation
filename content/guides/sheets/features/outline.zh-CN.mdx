...
如果您拥有 Univer 的商业许可证，请参阅[在客户端中使用许可证](/guides/server-integration/license#in-preset-mode)进行配置。
...
如果您拥有 Univer 的商业许可证，请参阅[在客户端中使用许可证](/guides/server-integration/license#in-plugin-mode)进行配置。
