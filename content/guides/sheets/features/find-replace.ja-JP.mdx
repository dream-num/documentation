...
<MetaData
  ...
  meta={{
    ...
    plugins: [{
      ...
      locale: '@univerjs/sheets-find-replace/locale/ja-JP',
    }],
    server: false,
  }}
/>
...
import SheetsFindReplaceJaJP from '@univerjs/sheets-find-replace/locale/ja-JP' // [!code ++]
...
以下は [`FTextFinder`](https://docs.univer.ai/reference/facade/find-replace) の主なメソッドです。
