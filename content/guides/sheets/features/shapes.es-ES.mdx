...
Si tiene una licencia comercial para Univer, consulte [Uso de licencia en el cliente](/guides/license#in-preset-mode) para la configuración.
...
Si tiene una licencia comercial para Univer, consulte [Uso de la licencia en Client](/guides/license#in-plugin-mode) para la configuración.
