...
Univer の商用ライセンスをお持ちの場合、クライアント側での設定方法は [クライアントでのライセンスの使用](/guides/license#in-preset-mode) を参照してください。
...
Univer の商用ライセンスをお持ちの場合、クライアント側での設定方法は [Using License in Client](/guides/license#in-plugin-mode) を参照してください。
