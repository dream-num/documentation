...
If you have a commercial license for Univer, please refer to [Using License in Client](/guides/license#in-preset-mode) for configuration.
...
If you have a commercial license for Univer, please refer to [Using License in Client](/guides/license#in-plugin-mode) for configuration.
...
| Method                                                                                                                         | Description                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| [remove](https://docs.univer.ai/reference/facade/pivot-table#remove)                             | remove the pivot table from instance                                              |
...
| [reset](https://docs.univer.ai/reference/facade/pivot-table#reset)                               | reset the pivot table fields                                                      |
