...
If you have a commercial license for Univer, please refer to [Using License in Client](/guides/server-integration/license#in-preset-mode) for configuration.
...
If you have a commercial license for Univer, please refer to [Using License in Client](/guides/server-integration/license#in-plugin-mode) for configuration.
...
| [setValueFilter](https://docs.univer.ai/reference/facade/pivot-table#setValueFilter)             | set value filter                                                                  |
