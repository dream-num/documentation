...
If you have a commercial license for Univer, please refer to [Using License in Client](/server/license#in-preset-mode) for configuration.
...
[`FWorkbook.addPivotTable`](https://docs.univer.ai/reference/facade/workbook#addpivottable) method is used to add a pivot table, and it will return the `FPivotTable` instance if successful.
...
[`FWorkbook.getPivotTableByCell`](https://docs.univer.ai/reference/facade/workbook#getpivottablebycell) method is used to get a pivot table instance by the anchor cell, and it will return the `FPivotTable` instance if the target cell is in a pivot table.
...
There are some methods in the [`FPivotTable`](https://docs.univer.ai/reference/facade/pivot-table) instance, which can be used to operate the pivot table.

| Method                                                                                                                         | Description                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| [remove](/reference/facade/generic-pivot-table#remove)                             | remove the pivot table from instance                                              |
| [getConfig](https://docs.univer.ai/reference/facade/pivot-table#getconfig)                       | return the pivot table config, the source range info, anchor cell info and config |
| [addField](https://docs.univer.ai/reference/facade/pivot-table#addfield)                         | add a field to pivot table                                                        |
| [removeField](https://docs.univer.ai/reference/facade/pivot-table#removefield)                   | remove a field from pivot table                                                   |
| [updateFieldPosition](https://docs.univer.ai/reference/facade/pivot-table#updatefieldposition)   | update the field position in pivot table                                          |
| [updateValuePosition](https://docs.univer.ai/reference/facade/pivot-table#updatevalueposition)   | control the ∑Value position                                                       |
| [setSubtotalType](https://docs.univer.ai/reference/facade/pivot-table#setsubtotaltype)           | set the subtotal type of the field                                                |
| [setLabelSort](https://docs.univer.ai/reference/facade/pivot-table#setlabelsort)                 | set the label sort of the field                                                   |
| [setLabelManualFilter](https://docs.univer.ai/reference/facade/pivot-table#setlabelmanualfilter) | set the label filter of the field                                                 |
| [renameField](https://docs.univer.ai/reference/facade/pivot-table#renamefield)                   | rename the field                                                                  |
| [setValueFilter](/reference/facade/pivot-table#setvaluefilter)             | set value filter                                                                  |
| [reset](/reference/facade/generic-pivot-table#reset)                               | reset the pivot table fields                                                      |
| [setFieldsConfig](https://docs.univer.ai/reference/facade/pivot-table#setfieldsconfig)           | set the pivot table fields config                                                 |
| [getValueFilters](https://docs.univer.ai/reference/facade/pivot-table#getvaluefilters)           | get all value filters of the pivot table                                          |
...
Use `setShowDataAs()` on a value field to display its share of a row, column, or grand total, or a difference from a base item. This changes the displayed calculation without replacing the source data. `getShowDataAs()` reads the setting and `resetShowDataAs()` restores normal calculation.
...
The example uses an existing pivot table `fPivotTable`. Select a value field ID, not a source column or row field ID. Difference and running-total modes also require the appropriate base field and base item settings.
