...
Если у вас есть коммерческая лицензия Univer, следуйте инструкциям в разделе [Использование лицензии в клиенте](/guides/pro/license#in-preset-mode).
...
Если у вас есть коммерческая лицензия Univer, следуйте инструкциям в разделе [Использование лицензии в клиенте](/guides/pro/license#in-plugin-mode).
...
Создайте построитель фигуры с помощью `FWorksheet.newShape`, а затем вставьте фигуру методом `FWorksheet.insertShape`.
...
Создавайте соединительные линии с помощью `FWorksheet.newConnector`, а методом `FWorksheet.connectShapes` прикрепляйте оба конца линии к точкам соединения фигур.
...
Для изменения существующей фигуры используйте `FWorksheet.updateShape`, а для её удаления — `FWorksheet.removeShape`.
