...
Если у вас есть коммерческая лицензия Univer, следуйте инструкциям в разделе [Использование лицензии в клиенте](/guides/server-integration/license#in-preset-mode).
...
Если у вас есть коммерческая лицензия Univer, следуйте инструкциям в разделе [Использование лицензии в клиенте](/guides/server-integration/license#in-plugin-mode).
