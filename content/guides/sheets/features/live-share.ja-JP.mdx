...
<Callout type="warning" title="注意事項">
  ライブシェア機能を使用するには、Univer サーバーのサポートが必要です。Univer サーバーが正しくインストールおよび設定されていることを確認してください。詳細は、[ライセンス](/guides/license)を参照してください。
</Callout>
...
Univer の商用ライセンスをお持ちの場合は、[クライアントでのライセンスの使用](/guides/license#in-plugin-mode)を参照して設定を行ってください。
