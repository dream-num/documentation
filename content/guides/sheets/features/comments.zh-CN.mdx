...
如需配合 `UniverSheetsCollaborationPreset` 使用[协同编辑](/zh-CN/guides/sheets/features/collaboration)功能，请确保在 `UniverSheetsThreadCommentPreset` 中传入 `collaboration: true` 选项。
...
如使用[协同编辑](/zh-CN/guides/sheets/features/collaboration)功能，需参照以下方式配置：
