...
完整 Facade API 类型定义，请查看 [FacadeAPI](/reference/facade/thread-comment)
...
以下是 [`FTheadCommentBuilder`](/reference/facade/thead-comment-builder) 上的一些成员方法：
...
以下是 [`FThreadComment`](https://docs.univer.ai/reference/facade/thread-comment) 上的一些成员方法：
