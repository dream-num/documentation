...
以下是 [`FTheadCommentBuilder`](https://reference.univer.ai/zh-TW/classes/FTheadCommentBuilder) 上的一些成員方法：
...
以下是 [`FThreadComment`](https://reference.univer.ai/zh-TW/classes/FThreadComment) 上的一些成員方法：
