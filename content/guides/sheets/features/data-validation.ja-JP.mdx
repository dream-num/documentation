...
<MetaData
  ...
  meta={{
    ...
    plugins: [{
      ...
      locale: '@univerjs/data-validation/locale/ja-JP',
    }, {
      client: '@univerjs/sheets-data-validation',
      facade: '@univerjs/sheets-data-validation/facade',
      locale: '@univerjs/sheets-data-validation/locale/ja-JP',
    }, {
...
設定項目の詳細は [`IUniverSheetsDataValidationUIConfig`](https://github.com/dream-num/univer/blob/dev/packages/sheets-data-validation-ui/src/config/config.ts) を参照してください。
...
設定項目の詳細は [`IUniverSheetsDataValidationPresetConfig`](https://github.com/dream-num/univer/tree/dev/presets/packages/preset-sheets-data-validation) を参照してください。
...
以下は [`FDataValidationBuilder`](/reference/facade/data-validation-builder) のメソッドの一部です:
