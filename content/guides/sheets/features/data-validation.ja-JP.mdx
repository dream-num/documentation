...
Complete configuration options can be found in the [`IUniverSheetsDataValidationPresetConfig`](https://github.com/dream-num/univer-presets/tree/dev/packages/preset-sheets-data-validation).
