...
[`FChartBuilderBase.registerChartTheme(themeName: string, theme: IEchartTheme)`](https://docs.univer.ai/reference/facade/worksheet#registercharttheme) メソッドはチャート テーマを登録します。テーマ名とテーマ オブジェクトを渡してカスタム テーマを登録します。
