...
```typescript
import ChartUIJaJP from '@univerjs-pro/chart-ui/locale/ja-JP' // [!code ++]
...
Univer Sheets は以下のチャート種類をサポートしています：

| チャート種類 | 説明 |
| --- | --- |
| Column | 縦棒グラフ |
| ColumnStacked | 積み上げ縦棒グラフ |
| ColumnPercentStacked | 百分比積み上げ縦棒グラフ |
| Bar | 横棒グラフ |
| BarStacked | 積み上げ横棒グラフ |
| BarPercentStacked | 百分比積み上げ横棒グラフ |
| Line | 折れ線グラフ |
| Area | 面グラフ |
| AreaStacked | 積み上げ面グラフ |
| AreaPercentStacked | 百分比積み上げ面グラフ |
| Pie | 円グラフ |
| Doughnut | ドーナツグラフ |
| Radar | レーダーチャート |
| Scatter | 散布図 |
...
<details>
   ...
   */
    title?: {
      ...
      /**
       * @property {string} [titleAlignment] チャート タイトルの配置。利用可能な値: 'left', 'center', 'right'。
       */
    ...
    /**
     * @property {RadarShape} [radar] レーダー チャートの設定。
     */
    radar?: {
      /**
       * @property {RadarShape} [shape] レーダー チャートの形状。
       */
      shape?: RadarShape
      /**
       * @property {boolean} [fill] レーダー チャートを塗りつぶすか。
       */
      fill?: boolean
    }
    /**
     * @property {string} [pie] 円グラフの設定。
     */
    pie?: {
      /**
       * @property {number} [doughnutHole] ドーナツの穴のサイズ。
       */
      doughnutHole: number
      /**
       * @property {string} [borderColor] 円グラフの枠線色。
       */
      borderColor: string
      /**
       * @property {boolean} [hasPaddingAngle] セクターに隙間を持たせるか。
       */
      hasPaddingAngle: boolean
      /**
       * @property {boolean} [isHalfPie] 半円グラフにするか。
       */
      isHalfPie: boolean
      /**
       * @property {boolean} [rosePie] ばらグラフにするか。
       */
      rosePie: boolean
      /**
       * @property {boolean} [showLabelLine] ラベル ラインを表示するか。
       */
