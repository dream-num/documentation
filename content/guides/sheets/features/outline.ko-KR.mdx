...
Univer 상용 라이선스를 보유하고 있다면 [클라이언트에서 라이선스 사용하기](/guides/license#in-preset-mode)를 참고하여 설정하세요.
...
Univer 상용 라이선스를 보유하고 있다면 [클라이언트에서 라이선스 사용하기](/guides/license#in-plugin-mode)를 참고하여 설정하세요.
