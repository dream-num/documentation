...
Only available with a [license](en-US/guides/sheets/getting-started/pro/license), users without a license will face usage restrictions, and the save operation will return `false`.
...
Only available with a [license](en-US/guides/sheets/getting-started/pro/license), users without a license will face usage restrictions, and the save operation will return `false` on failure, or a base64 string of the image on success.
