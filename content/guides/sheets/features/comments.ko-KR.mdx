...
전체 Facade API 타입 정의는 [FacadeAPI](/reference/facade/thread-comment)에서 확인할 수 있습니다.
...
다음은 [`FTheadCommentBuilder`](/reference/facade/thead-comment-builder)의 일부 멤버 메서드입니다.
...
- `FfWorksheet.getComments()`: 워크시트의 모든 댓글을 가져옵니다
