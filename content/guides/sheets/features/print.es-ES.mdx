...
Si tiene una licencia comercial licencia para Univer, consulte [Uso de la licencia en el cliente](/server/license#in-plugin-mode) para la configuración.
...
<Callout>
  El ajuste preestablecido `UniverSheetsAdvancedPreset` de `@univerjs/preset-sheets-advanced` depende del
  `UniverSheetsDrawingPreset` preestablecido en tiempo de ejecución. Primero instale `@univerjs/preset-sheets-drawing`.
</Callout>
...
Solo disponible con una [licencia](/server/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardar volverá `false`.
...
Solo disponible con una [licencia](/server/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardado volverá `false` en caso de error, o una cadena base64 de la imagen en caso de éxito.
