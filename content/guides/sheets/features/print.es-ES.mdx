...
Si tiene una licencia comercial licencia para Univer, consulte [Uso de la licencia en el cliente](/guides/license#in-plugin-mode) para la configuración.
...
Solo disponible con una [licencia](/guides/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardar volverá `false`.
...
Solo disponible con una [licencia](/guides/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardado volverá `false` en caso de error, o una cadena base64 de la imagen en caso de éxito.
