...
Solo disponible con una [licencia](/guides/pro/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardar volverá `false`.
...
Solo disponible con una [licencia](/guides/pro/license), los usuarios sin licencia enfrentarán restricciones de uso y la operación de guardado volverá `false` en caso de error, o una cadena base64 de la imagen en caso de éxito.
