...
返回一個 [`FFilter`](https://reference.univer.ai/zh-TW/classes/FFilter) 物件，若 sheet 沒有篩選器，則返回 `null`。

- `FWorksheet` 物件上的 [`getFilter()`](https://reference.univer.ai/zh-TW/classes/FWorksheet#getfilter)
- `FRange` 物件上的 [`getFilter()`](https://reference.univer.ai/zh-TW/classes/FRange#getfilter)
...
建立一個 [`FFilter`](https://reference.univer.ai/zh-TW/classes/FFilter) 物件，若 sheet 已經有篩選器，則返回 `null`。

- `FRange` 物件上的 [`createFilter()`](https://reference.univer.ai/zh-TW/classes/FRange#createfilter)
...
[`FFilter.remove()`](https://reference.univer.ai/zh-TW/classes/FFilter#remove) 方法移除篩選器。
...
[`FFilter.getColumnFilterCriteria(column)`](https://reference.univer.ai/zh-TW/classes/FFilter#getcolumnfiltercriteria) 方法返回指定列的篩選條件。
...
[`FFilter.setColumnFilterCriteria(column, criteria)`](https://reference.univer.ai/zh-TW/classes/FFilter#setcolumnfiltercriteria) 方法設定指定列的篩選條件。
...
- [`FFilter.removeColumnFilterCriteria(column)`](https://reference.univer.ai/zh-TW/classes/FFilter#removecolumnfiltercriteria) 方法移除指定列的篩選條件。
- [`FFilter.removeFilterCriteria()`](https://reference.univer.ai/zh-TW/classes/FFilter#removefiltercriteria) 方法移除所有列的篩選條件。
...
[`FFilter.getFilteredOutRows()`](https://reference.univer.ai/zh-TW/classes/FFilter#getfilteredoutrows) 方法返回一個陣列，包含被篩選掉的行的索引。
