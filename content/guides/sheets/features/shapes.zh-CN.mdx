...
如果你持有 Univer 商业许可，请参考 [客户端许可证使用说明](/guides/server-integration/license#in-preset-mode) 进行配置。
...
如果你持有 Univer 商业许可，请参考 [客户端许可证使用说明](/guides/server-integration/license#in-plugin-mode) 进行配置。
