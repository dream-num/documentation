...
Si vous disposez d’une licence commerciale Univer, consultez la section [Utiliser une licence côté client](/guides/server-integration/license#in-preset-mode) pour effectuer la configuration.
...
Si vous disposez d’une licence commerciale Univer, consultez la section [Utiliser une licence côté client](/guides/server-integration/license#in-plugin-mode) pour effectuer la configuration.
...
Cette fonctionnalité est uniquement disponible avec une [licence](/guides/server-integration/license). Sans licence, son utilisation est restreinte et l’opération d’enregistrement renvoie `false`.
...
Cette fonctionnalité est uniquement disponible avec une [licence](/guides/server-integration/license). Sans licence, son utilisation est restreinte. L’opération d’enregistrement renvoie `false` en cas d’échec, ou une chaîne base64 contenant l’image en cas de réussite.
