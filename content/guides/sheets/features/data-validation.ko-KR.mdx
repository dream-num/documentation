...
전체 설정 옵션은 [`IUniverSheetsDataValidationPresetConfig`](https://github.com/dream-num/univer/tree/dev/presets/packages/preset-sheets-data-validation)에서 확인할 수 있습니다.
...
다음은 [`FDataValidationBuilder`](/reference/facade/data-validation-builder)의 주요 멤버 메서드입니다.
