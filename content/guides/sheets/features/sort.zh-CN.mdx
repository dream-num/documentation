...
[`FWorksheet.sort(colIndex, asc)`](https://docs.univer.ai/reference/facade/worksheet#sort) 方法可以按指定的列对工作表进行排序。
...
[`FRange.sort(column)`](https://docs.univer.ai/reference/facade/range#sort) 方法可以按指定的列和顺序对给定范围内的单元格进行排序。
