...
如果你持有 Univer 商業授權，請參考 [在客戶端使用 License](/guides/server-integration/license#in-preset-mode) 進行設定。
...
如果你持有 Univer 商業授權，請參考 [在客戶端使用 License](/guides/server-integration/license#in-plugin-mode) 進行設定。
