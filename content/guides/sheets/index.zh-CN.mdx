...
在屏幕的左侧是文档导航栏。文档页面按从基础到高级的顺序组织，你可以按照这个顺序循序渐进地了解 Univer，或者跳到你感兴趣的章节。你还可以在侧边栏的顶部切换 Univer Sheets 的文档。
...
在设计之初，Univer 就被设计为高度可扩展的，因此你可以根据自己的需求来定制它。我们建议你阅读[架构](/blog/univer)部分，了解 Univer Sheets 的结构以及如何扩展它。也可以从 [如何编写 CSV 导入插件](/blog/csv-import-plugin) 开始。
