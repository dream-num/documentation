...
| cellData | `IObjectMatrixPrimitiveType<ICellData>` | Matrix of cell contents. [More details.](/en-US/guides/sheets/model/cell-data) |
...
| [defaultStyle](/en-US/guides/sheets/features/core/default-style)? | `Nullable<IStyleData>` | The default style of worksheet|
