---
title: Worksheet Data Structure
icon: Notebook
---
...
| cellData | `IObjectMatrixPrimitiveType<ICellData>` | Matrix of cell contents. [More details.](/guides/sheets/model/cell-data) |
...
| backgroundImage? | `IWorksheetBackgroundImage` | Optional tiled image source: `{ source: string; imageSourceType: ImageSourceType }`. See [background images](/guides/sheets/features/images#worksheet-background). |
