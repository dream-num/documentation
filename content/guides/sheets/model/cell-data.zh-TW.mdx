...
[關於在儲存格輸入以 0 開頭或可轉換為日期格式的數字時，不想被預設轉換](/guides/sheets/features/core/numfmt#usage)
...
可配置 `disableForceStringAlert` 和 `disableForceStringMark` 來禁用強制文字警告和標記，配置項位置見：
  - [預設模式](/guides/sheets/features/core#univerjspreset-sheets-core)
  - [外掛模式](/guides/sheets/features/core#univerjssheets-ui)
