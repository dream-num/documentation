...
| cellData | `IObjectMatrixPrimitiveType<ICellData>` | 单元格内容的矩阵。[详情](/zh-CN/guides/sheets/model/cell-data) |
...
| [defaultStyle](/zh-CN/guides/sheets/features/core/default-style)? | `Nullable<IStyleData>` | 默认工作表样式 |
