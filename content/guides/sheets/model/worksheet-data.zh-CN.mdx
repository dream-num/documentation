...
| backgroundImage? | `IWorksheetBackgroundImage` | 可选的平铺图片来源：`{ source: string; imageSourceType: ImageSourceType }`。参见[背景图](/guides/sheets/features/images#worksheet-background)。 |
