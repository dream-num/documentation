...
[I don't want the cell to be converted by default when entering a number starting with 0 or a number that can be converted to a date format](/guides/sheets/features/core/numfmt#usage)
...
You can control whether to enable the force text alert and mark by configuring `disableForceStringAlert` and `disableForceStringMark`. See the configuration location:
  - [Preset Mode](/guides/sheets/features/core#univerjspreset-sheets-core)
  - [Plugin Mode](/guides/sheets/features/core#univerjssheets-ui)
