...
[关于单元格输入带有0开头或可转换为日期格式的数字时，不想被默认转换](/guides/sheets/features/core/numfmt#usage)
...
可配置 `disableForceStringAlert` 和 `disableForceStringMark` 来禁用强制字符串警告和标记，配置项位置见：
  - [预设模式](/guides/sheets/features/core#univerjspreset-sheets-core)
  - [插件模式](/guides/sheets/features/core#univerjssheets-ui)
