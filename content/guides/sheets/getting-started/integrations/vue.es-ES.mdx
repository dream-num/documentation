...
Antes de integrar Univer en un proyecto Vue, lee la [instalación y el uso básico](/guides/sheets/getting-started/installation) y familiarízate con los componentes de Vue y sus hooks del ciclo de vida.
