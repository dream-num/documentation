...
Before integrating Univer into an Vue project, read [installation and basic usage](/guides/sheets/getting-started/installation) and familiarize yourself with Vue components and lifecycle hooks.
