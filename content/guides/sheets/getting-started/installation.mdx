...
Before, we have introduced [the namespace specification of Univer in Preset Mode](/guides/docs/getting-started/installation#namespace-specification). Here we will continue to use the same namespace specification to introduce plugins.
