...
Univer stellt UMD-Builds für Plugins bereit. Wenn Sie CDN-Skript-Tags verwenden, müssen Sie die UMD-Builds jedes Plugins und deren Abhängigkeiten manuell einbinden. Dieser Vorgang ist umständlich, daher empfehlen wir, ihn nur zu verwenden, nachdem Sie den Plugin-Mechanismus, einschließlich der Plugin-Abhängigkeiten und der Reihenfolge der Stildateien, vollständig verstanden haben.
