---
title: Univer Sheets
description: Univer Sheets is the spreadsheet component of Univer Office SDK, supporting both browser and Node.js, with flexible, extensible, and customizable features.
icon: SheetsAppIcon
---
...
For more details, please refer to the pages under the [Features](/guides/sheets/features/core) section.
...
To get started, check out the [Quick Start](/guides/sheets/getting-started/installation) guide.
