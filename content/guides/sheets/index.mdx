...
Univer is designed to be highly extensible so you can shape it to fit your needs. We recommend reading the [Architecture](/blog/univer) section to understand the structure of Univer Sheets and how to extend it. You can also start with the [How to Write a CSV Import Plugin](/blog/csv-import-plugin).
