...
For more details, please refer to the pages under the [Features](/en-US/guides/sheets/features/core) section. The core and major features are open-sourced on [GitHub](
...
To get started, check out the [Quick Start](/en-US/guides/sheets/getting-started/quickstart) guide.
...
Univer is designed to be highly extensible so you can shape it to fit your needs. We recommend reading the [Architecture](/en-US/guides/recipes/architecture/univer) section to understand the structure of Univer Sheets and how to extend it. You can also start with the [How to Write a CSV Import Plugin](/en-US/guides/recipes/practices/csv-import-plugin).
