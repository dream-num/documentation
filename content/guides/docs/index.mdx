---
title: Univer Docs
description: Univer Docs is the electronic document component of Univer, supporting both browser and Node.js, with flexible, extensible, and customizable features.
icon: 'BookText'
---
...
To get started, check out the [Quick Start](/en-US/guides/docs/getting-started/quickstart) guide.
