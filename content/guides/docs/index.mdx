...
For more details, please refer to the pages under the [Features](/en-US/guides/docs/features/core) section. The core and major features are open-sourced on [GitHub](https://github.com/dream-num/univer) and are free to use.
