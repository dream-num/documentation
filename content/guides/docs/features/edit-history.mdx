...
Complete [collaboration integration](/guides/server-integration/collaboration) and [license configuration](/guides/server-integration/license). Verify that two sessions can edit the same Docs document and that changes survive a reload.
