...
If you are using the [Collaboration](/guides/docs/features/collaboration) feature, make sure to pass the `collaboration: true` option in `UniverDocsDrawingPreset`:
