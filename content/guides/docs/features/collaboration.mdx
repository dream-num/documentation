...
<MetaData
  ...
  meta={{
    ...
    plugins: [{
      ...
      locale: '@univerjs-pro/collaboration-client-ui/locales/en-US',
...
- You can create a blank document using the [Create Document](/en-US/guides/docs/getting-started/pro/api#create-document) API.
