...
Si tienes una licencia comercial de Univer, consulta [Uso de la licencia en el cliente](/guides/server-integration/license#in-plugin-mode) para la configuración.
