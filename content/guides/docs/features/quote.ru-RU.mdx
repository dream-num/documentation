...
Если у вас есть коммерческая лицензия Univer, ознакомьтесь с разделом [Использование лицензии в клиенте](/guides/server-integration/license#in-plugin-mode).
