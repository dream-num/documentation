...
Si tiene una licencia comercial de Univer, consulte [Uso de la licencia en Cliente](/guides/server-integration/license#in-plugin-mode) para la configuración.
