...
En mode plugin, importez d'abord l'extension Facade :

```typescript
import '@univerjs/docs-drawing/facade'
```

Utilisez `FDocument` pour insérer, rechercher et gérer les images du document :
...
L'objet `FDocumentImage` renvoyé permet de redimensionner, faire pivoter, repositionner, réorganiser ou supprimer l'image.
