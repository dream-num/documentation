...
Если у вас есть коммерческая лицензия Univer, ознакомьтесь с разделом [Использование лицензии в клиенте](/guides/license#in-plugin-mode), чтобы настроить её.
