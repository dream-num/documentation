...
如需配合 `UniverDocsCollaborationPreset` 使用[协同编辑](/zh-CN/guides/docs/features/collaboration)功能，请确保在 `UniverDocsThreadCommentPreset` 中传入 `collaboration: true` 选项。
...
如使用[协同编辑](/zh-CN/guides/docs/features/collaboration)功能，需参照以下方式配置：
