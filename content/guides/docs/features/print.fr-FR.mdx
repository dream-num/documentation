...
Si vous disposez d’une licence commerciale Univer, consultez la page [Utiliser une licence côté client](/server/license#in-preset-mode) pour savoir comment la configurer.
