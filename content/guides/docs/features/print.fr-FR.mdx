...
Si vous disposez d’une licence commerciale Univer, consultez la page [Utiliser une licence côté client](/guides/license#in-preset-mode) pour savoir comment la configurer.
