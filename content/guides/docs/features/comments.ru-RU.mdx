...
Если вы используете функцию [совместной работы](/guides/docs/features/collaboration) с `UniverDocsCollaborationPreset`, обязательно передайте параметр `collaboration: true` в `UniverDocsThreadCommentPreset`:
