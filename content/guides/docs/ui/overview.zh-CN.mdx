...
<Cards>
  <Card title="自定义主题与暗黑模式" href="/guides/docs/ui/themes" />
</Cards>
...
<Cards>
  <Card title="自定义组件" href="/guides/docs/ui/components" />
  <Card title="图标" href="/guides/icons" />
</Cards>

## 菜单顺序与网格布局 [#menu-configuration]

通过 [`order`、`gridLayout` 和 `updateMenuConfig()`](/guides/docs/features/core#menu-order-and-grid-layout) 配置页签、分组和菜单项的顺序、网格位置及运行时更新；指南也提供自定义菜单 Facade 配置的入口。
