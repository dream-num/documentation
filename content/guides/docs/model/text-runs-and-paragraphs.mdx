...
Univer Docs does not store rich text as a nested tree. It stores plain text in `body.dataStream`[^utf16-offsets], and then uses index ranges to attach style and structure to the text.
