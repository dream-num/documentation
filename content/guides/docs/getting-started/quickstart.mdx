...
Functional plugins can store resources, such as images, etc., through the `resources` field. For more information, see [Plugin Custom Model](/en-US/guides/recipes/custom-model).
