...
<Callout type="warning" title="Caution">
  As mentioned in the previous section on [installation](/en-US/guides/docs/getting-started/installation#usage-1), not all plugins include language packs. We will specify this in the documentation for each feature.
</Callout>
