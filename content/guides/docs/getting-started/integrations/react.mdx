...
<Callout>
  If you are looking for how to use React components as custom components, please refer to [here](/guides/docs/ui/components#react).
</Callout>

Before integrating Univer into a React project, please ensure you have read the [Univer installation and basic usage](/guides/docs/getting-started/installation) section and understand the basic concepts and lifecycle hooks of React.
