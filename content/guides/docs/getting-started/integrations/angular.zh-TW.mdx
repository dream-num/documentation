...
<Callout>
  如果你正在尋找使用 Angular 元件作為自訂元件的方法，請參閱[此處](/guides/docs/ui/components#angular)。
</Callout>

將 Univer 整合到 Angular 專案前，請先閱讀[安裝與基本使用](/guides/docs/getting-started/installation)章節，並了解 Angular 元件與生命週期鉤子。
