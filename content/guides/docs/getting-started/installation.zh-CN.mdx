...
* 在 [基础概念](/zh-CN/guides/docs/getting-started/quickstart#basic-concepts) 章节了解本章中出现的插件、命令和 Facade API 等概念。
* 在 [功能](/zh-CN/guides/docs/features/core) 相关章节中了解修改电子表格数据的所有操作。
