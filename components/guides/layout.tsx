...
export async function GuidesLayout({
  ...
  return (
    ...
    >
      ...
      <div
        className="
          mx-auto grid w-full max-w-384 grid-cols-1 gap-8 px-4 py-8
          lg:min-h-0 lg:flex-1 lg:grid-cols-[18rem_minmax(0,1fr)] lg:gap-4 lg:overflow-hidden lg:px-6 lg:pt-8 lg:pb-0
          xl:grid-cols-[18rem_minmax(0,1fr)_17rem]
        "
      >
        <aside
          ...
          className="
            hidden
            lg:block lg:min-h-0 lg:overflow-y-auto lg:overscroll-contain lg:pr-4 lg:pb-8
          "
        >
          <GuidesSidebar
        ...
        <main
          className="
            min-w-0
            lg:min-h-0 lg:overflow-y-auto lg:overscroll-contain lg:px-6 lg:pb-8
          "
        ...
        <aside
          ...
          className="
            hidden
            xl:block xl:min-h-0 xl:overflow-y-auto xl:overscroll-contain xl:pb-8 xl:pl-4
          "
        >
